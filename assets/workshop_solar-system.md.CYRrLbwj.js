...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:_n,depthTest:!1,depthWrite:!1})}function ef(i,t,e){const n=new Float32Array(Vn),s=new U(0,1,0);return new an({name:"SphericalGaussianBlur",defines:{n:Vn,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/e,CUBEUV_MAX_MIP:`${i}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:n},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:s}},vertexShader:Rs(),fragmentShader:`
	...
	`}function nf(i){let t=new WeakMap,e=null;function n(o){if(o&&o.isTexture){const c=o.mapping,l=c===Tr||c===br,u=c===kn||c===fi;if(l||u){let d=t.get(o);const f=d!==void 0?d.texture.pmremVersion:0;if(o.isRenderTargetTexture&&o.pmremVersion!==f)return e===null&&(e=new xo(i)),d=l?e.fromEquirectangular(o,d):e.fromCubemap(o,d),d.texture.pmremVersion=o.pmremVersion,t.set(o,d),d.texture;if(d!==void 0)return d.texture;{const _=o.image;return l&&_&&_.height>0||u&&_&&s(_)?(e===null&&(e=new xo(i)),d=l?e.fromEquirectangular(o):e.fromCubemap(o),d.texture.pmremVersion=o.pmremVersion,t.set(o,d),o.addEventListener("dispose",r),d.texture):null}}}return o}function s(o){let c=0;const l=6;for(let u=0;u<l;u++)o[u]!==void 0&&c++;return c===l}function r(o){const c=o.target;c.removeEventListener("dispose",r);const l=t.get(c);l!==void 0&&(t.delete(c),l.dispose())}function a(){t=new WeakMap,e!==null&&(e.dispose(),e=null)}return{get:n,dispose:a}}function sf(i){const t={};function e(n){if(t[n]!==void 0)return t[n];const s=i.getExtension(n);return t[n]=s,s}return{has:function(n){return e(n)!==null},init:function(){e("EXT_color_buffer_float"),e("WEBGL_clip_cull_distance"),e("OES_texture_float_linear"),e("EXT_color_buffer_half_float"),e("WEBGL_multisampled_render_to_texture"),e("WEBGL_render_shared_exponent")},get:function(n){const s=e(n);return s===null&&Di("WebGLRenderer: "+n+" extension not supported."),s}}}function rf(i,t,e,n){const s={},r=new WeakMap;function a(d){const f=d.target;f.index!==null&&t.remove(f.index);for(const v in f.attributes)t.remove(f.attributes[v]);f.removeEventListener("dispose",a),delete s[f.id];const _=r.get(f);_&&(t.remove(_),r.delete(f)),n.releaseStatesOfGeometry(f),f.isInstancedBufferGeometry===!0&&delete f._maxInstanceCount,e.memory.geometries--}function o(d,f){return s[f.id]===!0||(f.addEventListener("dispose",a),s[f.id]=!0,e.memory.geometries++),f}function c(d){const f=d.attributes;for(const _ in f)t.update(f[_],i.ARRAY_BUFFER)}function l(d){const f=[],_=d.index,v=d.attributes.position;let M=0;if(_!==null){const A=_.array;M=_.version;for(let w=0,E=A.length;w<E;w+=3){const T=A[w+0],b=A[w+1],C=A[w+2];f.push(T,b,b,C,C,T)}}else if(v!==void 0){const A=v.array;M=v.version;for(let w=0,E=A.length/3-1;w<E;w+=3){const T=w+0,b=w+1,C=w+2;f.push(T,b,b,C,C,T)}}else return;const p=new(sl(f)?ll:ol)(f,1);p.version=M;const h=r.get(d);h&&t.remove(h),r.set(d,p)}function u(d){const f=r.get(d);if(f){const _=d.index;_!==null&&f.version<_.version&&l(d)}else l(d);return r.get(d)}return{get:o,update:c,getWireframeAttribute:u}}function af(i,t,e){let n;function s(f){n=f}let r,a;function o(f){r=f.type,a=f.bytesPerElement}function c(f,_){i.drawElements(n,_,r,f*a),e.update(_,n,1)}function l(f,_,v){v!==0&&(i.drawElementsInstanced(n,_,r,f*a,v),e.update(_,n,v))}function u(f,_,v){if(v===0)return;t.get("WEBGL_multi_draw").multiDrawElementsWEBGL(n,_,0,r,f,0,v);let p=0;for(let h=0;h<v;h++)p+=_[h];e.update(p,n,1)}function d(f,_,v,M){if(v===0)return;const p=t.get("WEBGL_multi_draw");if(p===null)for(let h=0;h<f.length;h++)l(f[h]/a,_[h],M[h]);else{p.multiDrawElementsInstancedWEBGL(n,_,0,r,f,0,M,0,v);let h=0;for(let A=0;A<v;A++)h+=_[A]*M[A];e.update(h,n,1)}}this.setMode=s,this.setIndex=o,this.render=c,this.renderInstances=l,this.renderMultiDraw=u,this.renderMultiDrawInstances=d}function of(i){const t={geometries:0,textures:0},e={frame:0,calls:0,triangles:0,points:0,lines:0};function n(r,a,o){switch(e.calls++,a){case i.TRIANGLES:e.triangles+=o*(r/3);break;case i.LINES:e.lines+=o*(r/2);break;case i.LINE_STRIP:e.lines+=o*(r-1);break;case i.LINE_LOOP:e.lines+=o*r;break;case i.POINTS:e.points+=o*r;break;default:Gt("WebGLInfo: Unknown draw mode:",a);break}}function s(){e.calls=0,e.triangles=0,e.points=0,e.lines=0}return{memory:t,render:e,programs:null,autoReset:!0,reset:s,update:n}}function lf(i,t,e){const n=new WeakMap,s=new le;function r(a,o,c){const l=a.morphTargetInfluences,u=o.morphAttributes.position||o.morphAttributes.normal||o.morphAttributes.color,d=u!==void 0?u.length:0;let f=n.get(o);if(f===void 0||f.count!==d){let g=function(){C.dispose(),n.delete(o),o.removeEventListener("dispose",g)};f!==void 0&&f.texture.dispose();const _=o.morphAttributes.position!==void 0,v=o.morphAttributes.normal!==void 0,M=o.morphAttributes.color!==void 0,p=o.morphAttributes.position||[],h=o.morphAttributes.normal||[],A=o.morphAttributes.color||[];let w=0;_===!0&&(w=1),v===!0&&(w=2),M===!0&&(w=3);let E=o.attributes.position.count*w,T=1;E>t.maxTextureSize&&(T=Math.ceil(E/t.maxTextureSize),E=t.maxTextureSize);const b=new Float32Array(E*T*4*d),C=new rl(b,E,T,d);C.type=Je,C.needsUpdate=!0;const F=w*4;for(let S=0;S<d;S++){const D=p[S],z=h[S],O=A[S],H=E*T*4*S;for(let Y=0;Y<D.count;Y++){const G=Y*F;_===!0&&(s.fromBufferAttribute(D,Y),b[H+G+0]=s.x,b[H+G+1]=s.y,b[H+G+2]=s.z,b[H+G+3]=0),v===!0&&(s.fromBufferAttribute(z,Y),b[H+G+4]=s.x,b[H+G+5]=s.y,b[H+G+6]=s.z,b[H+G+7]=0),M===!0&&(s.fromBufferAttribute(O,Y),b[H+G+8]=s.x,b[H+G+9]=s.y,b[H+G+10]=s.z,b[H+G+11]=O.itemSize===4?s.w:1)}}f={count:d,texture:C,size:new Ct(E,T)},n.set(o,f),o.addEventListener("dispose",g)}if(a.isInstancedMesh===!0&&a.morphTexture!==null)c.getUniforms().setValue(i,"morphTexture",a.morphTexture,e);else{let _=0;for(let M=0;M<l.length;M++)_+=l[M];const v=o.morphTargetsRelative?1:1-_;c.getUniforms().setValue(i,"morphTargetBaseInfluence",v),c.getUniforms().setValue(i,"morphTargetInfluences",l)}c.getUniforms().setValue(i,"morphTargetsTexture",f.texture,e),c.getUniforms().setValue(i,"morphTargetsTextureSize",f.size)}return{update:r}}function cf(i,t,e,n){let s=new WeakMap;function r(c){const l=n.render.frame,u=c.geometry,d=t.get(c,u);if(s.get(d)!==l&&(t.update(d),s.set(d,l)),c.isInstancedMesh&&(c.hasEventListener("dispose",o)===!1&&c.addEventListener("dispose",o),s.get(c)!==l&&(e.update(c.instanceMatrix,i.ARRAY_BUFFER),c.instanceColor!==null&&e.update(c.instanceColor,i.ARRAY_BUFFER),s.set(c,l))),c.isSkinnedMesh){const f=c.skeleton;s.get(f)!==l&&(f.update(),s.set(f,l))}return d}function a(){s=new WeakMap}function o(c){const l=c.target;l.removeEventListener("dispose",o),e.remove(l.instanceMatrix),l.instanceColor!==null&&e.remove(l.instanceColor)}return{update:r,dispose:a}}const hf={[ko]:"LINEAR_TONE_MAPPING",[Wo]:"REINHARD_TONE_MAPPING",[Xo]:"CINEON_TONE_MAPPING",[da]:"ACES_FILMIC_TONE_MAPPING",[qo]:"AGX_TONE_MAPPING",[jo]:"NEUTRAL_TONE_MAPPING",[Yo]:"CUSTOM_TONE_MAPPING"};function uf(i,t,e,n,s){const r=new en(t,e,{type:i,depthBuffer:n,stencilBuffer:s}),a=new en(t,e,{type:xn,depthBuffer:!1,stencilBuffer:!1}),o=new Ie;o.setAttribute("position",new be([-1,3,0,-1,-1,0,3,-1,0],3)),o.setAttribute("uv",new be([0,2,0,0,2,0],2));const c=new $c({uniforms:{tDiffuse:{value:null}},vertexShader:`
			...
			void main() {
				...
				#endif
			}`,depthTest:!1,depthWrite:!1}),l=new Ee(o,c),u=new _l(-1,1,1,-1,0,1);let d=null,f=null,_=!1,v,M=null,p=[],h=!1;this.setSize=function(A,w){r.setSize(A,w),a.setSize(A,w);for(let E=0;E<p.length;E++){const T=p[E];T.setSize&&T.setSize(A,w)}},this.setEffects=function(A){p=A,h=p.length>0&&p[0].isRenderPass===!0;const w=r.width,E=r.height;for(let T=0;T<p.length;T++){const b=p[T];b.setSize&&b.setSize(w,E)}},this.begin=function(A,w){if(_||A.toneMapping===tn&&p.length===0)return!1;if(M=w,w!==null){const E=w.width,T=w.height;(r.width!==E||r.height!==T)&&this.setSize(E,T)}return h===!1&&A.setRenderTarget(r),v=A.toneMapping,A.toneMapping=tn,!0},this.hasRenderPass=function(){return h},this.end=function(A,w){A.toneMapping=v,_=!0;let E=r,T=a;for(let b=0;b<p.length;b++){const C=p[b];if(C.enabled!==!1&&(C.render(A,T,E,w),C.needsSwap!==!1)){const F=E;E=T,T=F}}if(d!==A.outputColorSpace||f!==A.toneMapping){d=A.outputColorSpace,f=A.toneMapping,c.defines={},Ht.getTransfer(d)===Kt&&(c.defines.SRGB_TRANSFER="");const b=hf[f];b&&(c.defines[b]=""),c.needsUpdate=!0}c.uniforms.tDiffuse.value=E.texture,A.setRenderTarget(M),A.render(l,u),M=null,_=!1},this.isCompositing=function(){return _},this.dispose=function(){r.dispose(),a.dispose(),o.dispose(),c.dispose()}}const xl=new Te,ca=new Li(1,1),vl=new rl,Ml=new Tc,Sl=new ul,Eo=[],yo=[],To=new Float32Array(16),bo=new Float32Array(9),Ao=new Float32Array(4);function gi(i,t,e){const n=i[0];if(n<=0||n>0)return i;const s=t*e;let r=Eo[s];if(r===void 0&&(r=new Float32Array(s),Eo[s]=r),t!==0){n.toArray(r,0);for(let a=1,o=0;a!==t;++a)o+=e,i[a].toArray(r,o)}return r}function fe(i,t){if(i.length!==t.length)return!1;for(let e=0,n=i.length;e<n;e++)if(i[e]!==t[e])return!1;return!0}function pe(i,t){for(let e=0,n=t.length;e<n;e++)i[e]=t[e]}function Cs(i,t){let e=yo[t];e===void 0&&(e=new Int32Array(t),yo[t]=e);for(let n=0;n!==t;++n)e[n]=i.allocateTextureUnit();return e}function df(i,t){const e=this.cache;e[0]!==t&&(i.uniform1f(this.addr,t),e[0]=t)}function ff(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(i.uniform2f(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(fe(e,t))return;i.uniform2fv(this.addr,t),pe(e,t)}}function pf(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(i.uniform3f(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else if(t.r!==void 0)(e[0]!==t.r||e[1]!==t.g||e[2]!==t.b)&&(i.uniform3f(this.addr,t.r,t.g,t.b),e[0]=t.r,e[1]=t.g,e[2]=t.b);else{if(fe(e,t))return;i.uniform3fv(this.addr,t),pe(e,t)}}function mf(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(i.uniform4f(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(fe(e,t))return;i.uniform4fv(this.addr,t),pe(e,t)}}function _f(i,t){const e=this.cache,n=t.elements;if(n===void 0){if(fe(e,t))return;i.uniformMatrix2fv(this.addr,!1,t),pe(e,t)}else{if(fe(e,n))return;Ao.set(n),i.uniformMatrix2fv(this.addr,!1,Ao),pe(e,n)}}function gf(i,t){const e=this.cache,n=t.elements;if(n===void 0){if(fe(e,t))return;i.uniformMatrix3fv(this.addr,!1,t),pe(e,t)}else{if(fe(e,n))return;bo.set(n),i.uniformMatrix3fv(this.addr,!1,bo),pe(e,n)}}function xf(i,t){const e=this.cache,n=t.elements;if(n===void 0){if(fe(e,t))return;i.uniformMatrix4fv(this.addr,!1,t),pe(e,t)}else{if(fe(e,n))return;To.set(n),i.uniformMatrix4fv(this.addr,!1,To),pe(e,n)}}function vf(i,t){const e=this.cache;e[0]!==t&&(i.uniform1i(this.addr,t),e[0]=t)}function Mf(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(i.uniform2i(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(fe(e,t))return;i.uniform2iv(this.addr,t),pe(e,t)}}function Sf(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(i.uniform3i(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else{if(fe(e,t))return;i.uniform3iv(this.addr,t),pe(e,t)}}function Ef(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(i.uniform4i(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(fe(e,t))return;i.uniform4iv(this.addr,t),pe(e,t)}}function yf(i,t){const e=this.cache;e[0]!==t&&(i.uniform1ui(this.addr,t),e[0]=t)}function Tf(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(i.uniform2ui(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(fe(e,t))return;i.uniform2uiv(this.addr,t),pe(e,t)}}function bf(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(i.uniform3ui(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else{if(fe(e,t))return;i.uniform3uiv(this.addr,t),pe(e,t)}}function Af(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(i.uniform4ui(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(fe(e,t))return;i.uniform4uiv(this.addr,t),pe(e,t)}}function wf(i,t,e){const n=this.cache,s=e.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s);let r;this.type===i.SAMPLER_2D_SHADOW?(ca.compareFunction=e.isReversedDepthBuffer()?Ma:va,r=ca):r=xl,e.setTexture2D(t||r,s)}function Rf(i,t,e){const n=this.cache,s=e.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),e.setTexture3D(t||Ml,s)}function Cf(i,t,e){const n=this.cache,s=e.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),e.setTextureCube(t||Sl,s)}function Pf(i,t,e){const n=this.cache,s=e.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),e.setTexture2DArray(t||vl,s)}function Df(i){switch(i){case 5126:return df;case 35664:return ff;case 35665:return pf;case 35666:return mf;case 35674:return _f;case 35675:return gf;case 35676:return xf;case 5124:case 35670:return vf;case 35667:case 35671:return Mf;case 35668:case 35672:return Sf;case 35669:case 35673:return Ef;case 5125:return yf;case 36294:return Tf;case 36295:return bf;case 36296:return Af;case 35678:case 36198:case 36298:case 36306:case 35682:return wf;case 35679:case 36299:case 36307:return Rf;case 35680:case 36300:case 36308:case 36293:return Cf;case 36289:case 36303:case 36311:case 36292:return Pf}}function Lf(i,t){i.uniform1fv(this.addr,t)}function If(i,t){const e=gi(t,this.size,2);i.uniform2fv(this.addr,e)}function Uf(i,t){const e=gi(t,this.size,3);i.uniform3fv(this.addr,e)}function Nf(i,t){const e=gi(t,this.size,4);i.uniform4fv(this.addr,e)}function Ff(i,t){const e=gi(t,this.size,4);i.uniformMatrix2fv(this.addr,!1,e)}function Of(i,t){const e=gi(t,this.size,9);i.uniformMatrix3fv(this.addr,!1,e)}function Bf(i,t){const e=gi(t,this.size,16);i.uniformMatrix4fv(this.addr,!1,e)}function zf(i,t){i.uniform1iv(this.addr,t)}function Vf(i,t){i.uniform2iv(this.addr,t)}function Gf(i,t){i.uniform3iv(this.addr,t)}function Hf(i,t){i.uniform4iv(this.addr,t)}function kf(i,t){i.uniform1uiv(this.addr,t)}function Wf(i,t){i.uniform2uiv(this.addr,t)}function Xf(i,t){i.uniform3uiv(this.addr,t)}function Yf(i,t){i.uniform4uiv(this.addr,t)}function qf(i,t,e){const n=this.cache,s=t.length,r=Cs(e,s);fe(n,r)||(i.uniform1iv(this.addr,r),pe(n,r));let a;this.type===i.SAMPLER_2D_SHADOW?a=ca:a=xl;for(let o=0;o!==s;++o)e.setTexture2D(t[o]||a,r[o])}function jf(i,t,e){const n=this.cache,s=t.length,r=Cs(e,s);fe(n,r)||(i.uniform1iv(this.addr,r),pe(n,r));for(let a=0;a!==s;++a)e.setTexture3D(t[a]||Ml,r[a])}function Kf(i,t,e){const n=this.cache,s=t.length,r=Cs(e,s);fe(n,r)||(i.uniform1iv(this.addr,r),pe(n,r));for(let a=0;a!==s;++a)e.setTextureCube(t[a]||Sl,r[a])}function Zf(i,t,e){const n=this.cache,s=t.length,r=Cs(e,s);fe(n,r)||(i.uniform1iv(this.addr,r),pe(n,r));for(let a=0;a!==s;++a)e.setTexture2DArray(t[a]||vl,r[a])}function $f(i){switch(i){case 5126:return Lf;case 35664:return If;case 35665:return Uf;case 35666:return Nf;case 35674:return Ff;case 35675:return Of;case 35676:return Bf;case 5124:case 35670:return zf;case 35667:case 35671:return Vf;case 35668:case 35672:return Gf;case 35669:case 35673:return Hf;case 5125:return kf;case 36294:return Wf;case 36295:return Xf;case 36296:return Yf;case 35678:case 36198:case 36298:case 36306:case 35682:return qf;case 35679:case 36299:case 36307:return jf;case 35680:case 36300:case 36308:case 36293:return Kf;case 36289:case 36303:case 36311:case 36292:return Zf}}class Jf{constructor(t,e,n){this.id=t,this.addr=n,this.cache=[],this.type=e.type,this.setValue=Df(e.type)}}class Qf{constructor(t,e,n){this.id=t,this.addr=n,this.cache=[],this.type=e.type,this.size=e.size,this.setValue=$f(e.type)}}class tp{constructor(t){this.id=t,this.seq=[],this.map={}}setValue(t,e,n){const s=this.seq;for(let r=0,a=s.length;r!==a;++r){const o=s[r];o.setValue(t,e[o.id],n)}}}const hr=/(\w+)(\])?(\[|\.)?/g;function wo(i,t){i.seq.push(t),i.map[t.id]=t}function ep(i,t,e){const n=i.name,s=n.length;for(hr.lastIndex=0;;){const r=hr.exec(n),a=hr.lastIndex;let o=r[1];const c=r[2]==="]",l=r[3];if(c&&(o=o|0),l===void 0||l==="["&&a+2===s){wo(e,l===void 0?new Jf(o,i,t):new Qf(o,i,t));break}else{let d=e.map[o];d===void 0&&(d=new tp(o),wo(e,d)),e=d}}}class Ms{constructor(t,e){this.seq=[],this.map={};const n=t.getProgramParameter(e,t.ACTIVE_UNIFORMS);for(let a=0;a<n;++a){const o=t.getActiveUniform(e,a),c=t.getUniformLocation(e,o.name);ep(o,c,this)}const s=[],r=[];for(const a of this.seq)a.type===t.SAMPLER_2D_SHADOW||a.type===t.SAMPLER_CUBE_SHADOW||a.type===t.SAMPLER_2D_ARRAY_SHADOW?s.push(a):r.push(a);s.length>0&&(this.seq=s.concat(r))}setValue(t,e,n,s){const r=this.map[e];r!==void 0&&r.setValue(t,n,s)}setOptional(t,e,n){const s=e[n];s!==void 0&&this.setValue(t,n,s)}static upload(t,e,n,s){for(let r=0,a=e.length;r!==a;++r){const o=e[r],c=n[o.id];c.needsUpdate!==!1&&o.setValue(t,c.value,s)}}static seqWithValue(t,e){const n=[];for(let s=0,r=t.length;s!==r;++s){const a=t[s];a.id in e&&n.push(a)}return n}}function Ro(i,t,e){const n=i.createShader(t);return i.shaderSource(n,e),i.compileShader(n),n}const np=37297;let ip=0;function sp(i,t){const e=i.split(`
`),n=[],s=Math.max(t-6,0),r=Math.min(t+6,e.length);for(let a=s;a<r;a++){const o=a+1;n.push(`${o===t?">":" "} ${o}: ${e[a]}`)}return n.join(`
`)}const Co=new Dt;function rp(i){Ht._getMatrix(Co,Ht.workingColorSpace,i);const t=`mat3( ${Co.elements.map(e=>e.toFixed(4))} )`;switch(Ht.getTransfer(i)){case Ss:return[t,"LinearTransferOETF"];case Kt:return[t,"sRGBTransferOETF"];default:return wt("WebGLProgram: Unsupported color space: ",i),[t,"LinearTransferOETF"]}}function Po(i,t,e){const n=i.getShaderParameter(t,i.COMPILE_STATUS),r=(i.getShaderInfoLog(t)||"").trim();if(n&&r==="")return"";const a=/ERROR: 0:(\d+)/.exec(r);if(a){const o=parseInt(a[1]);return e.toUpperCase()+`

`+r+`

`+sp(i.getShaderSource(t),o)}else return r}function ap(i,t){const e=rp(t);return[`vec4 ${i}( vec4 value ) {`,`	return ${e[1]}( vec4( value.rgb * ${e[0]}, value.a ) );`,"}"].join(`
`)}const op={[ko]:"Linear",[Wo]:"Reinhard",[Xo]:"Cineon",[da]:"ACESFilmic",[qo]:"AgX",[jo]:"Neutral",[Yo]:"Custom"};function lp(i,t){const e=op[t];return e===void 0?(wt("WebGLProgram: Unsupported toneMapping:",t),"vec3 "+i+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+i+"( vec3 color ) { return "+e+"ToneMapping( color ); }"}const hs=new U;function cp(){Ht.getLuminanceCoefficients(hs);const i=hs.x.toFixed(4),t=hs.y.toFixed(4),e=hs.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${t}, ${e} );`,"	return dot( weights, rgb );","}"].join(`
...
`)}function dp(i,t){const e={},n=i.getProgramParameter(t,i.ACTIVE_ATTRIBUTES);for(let s=0;s<n;s++){const r=i.getActiveAttrib(t,s),a=r.name;let o=1;r.type===i.FLOAT_MAT2&&(o=2),r.type===i.FLOAT_MAT3&&(o=3),r.type===i.FLOAT_MAT4&&(o=4),e[a]={type:r.type,location:i.getAttribLocation(t,a),locationSize:o}}return e}function Ri(i){return i!==""}function Do(i,t){const e=t.numSpotLightShadows+t.numSpotLightMaps-t.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,t.numDirLights).replace(/NUM_SPOT_LIGHTS/g,t.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,t.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,e).replace(/NUM_RECT_AREA_LIGHTS/g,t.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,t.numPointLights).replace(/NUM_HEMI_LIGHTS/g,t.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,t.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,t.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,t.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,t.numPointLightShadows)}function Lo(i,t){return i.replace(/NUM_CLIPPING_PLANES/g,t.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,t.numClippingPlanes-t.numClipIntersection)}const fp=/^[ \t]*#include +<([\w\d./]+)>/gm;function ha(i){return i.replace(fp,mp)}const pp=new Map;function mp(i,t){let e=Lt[t];if(e===void 0){const n=pp.get(t);if(n!==void 0)e=Lt[n],wt('WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',t,n);else throw new Error("Can not resolve #include <"+t+">")}return ha(e)}const _p=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Io(i){return i.replace(_p,gp)}function gp(i,t,e,n){let s="";for(let r=parseInt(t);r<parseInt(e);r++)s+=n.replace(/\[\s*i\s*\]/g,"[ "+r+" ]").replace(/UNROLLED_LOOP_INDEX/g,r);return s}function Uo(i){let t=`precision ${i.precision} float;
...
#define LOW_PRECISION`),t}const xp={[ps]:"SHADOWMAP_TYPE_PCF",[wi]:"SHADOWMAP_TYPE_VSM"};function vp(i){return xp[i.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}const Mp={[kn]:"ENVMAP_TYPE_CUBE",[fi]:"ENVMAP_TYPE_CUBE",[As]:"ENVMAP_TYPE_CUBE_UV"};function Sp(i){return i.envMap===!1?"ENVMAP_TYPE_CUBE":Mp[i.envMapMode]||"ENVMAP_TYPE_CUBE"}const Ep={[fi]:"ENVMAP_MODE_REFRACTION"};function yp(i){return i.envMap===!1?"ENVMAP_MODE_REFLECTION":Ep[i.envMapMode]||"ENVMAP_MODE_REFLECTION"}const Tp={[Ho]:"ENVMAP_BLENDING_MULTIPLY",[sc]:"ENVMAP_BLENDING_MIX",[rc]:"ENVMAP_BLENDING_ADD"};function bp(i){return i.envMap===!1?"ENVMAP_BLENDING_NONE":Tp[i.combine]||"ENVMAP_BLENDING_NONE"}function Ap(i){const t=i.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),7*16)),texelHeight:n,maxMip:e}}function wp(i,t,e,n){const s=i.getContext(),r=e.defines;let a=e.vertexShader,o=e.fragmentShader;const c=vp(e),l=Sp(e),u=yp(e),d=bp(e),f=Ap(e),_=hp(e),v=up(r),M=s.createProgram();let p,h,A=e.glslVersion?"#version "+e.glslVersion+`
...
`)+`
`+h);const w=A+p+a,E=A+h+o,T=Ro(s,s.VERTEX_SHADER,w),b=Ro(s,s.FRAGMENT_SHADER,E);s.attachShader(M,T),s.attachShader(M,b),e.index0AttributeName!==void 0?s.bindAttribLocation(M,0,e.index0AttributeName):e.morphTargets===!0&&s.bindAttribLocation(M,0,"position"),s.linkProgram(M);function C(D){if(i.debug.checkShaderErrors){const z=s.getProgramInfoLog(M)||"",O=s.getShaderInfoLog(T)||"",H=s.getShaderInfoLog(b)||"",Y=z.trim(),G=O.trim(),W=H.trim();let Z=!0,ht=!0;if(s.getProgramParameter(M,s.LINK_STATUS)===!1)if(Z=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,M,T,b);else{const at=Po(s,T,"vertex"),ut=Po(s,b,"fragment");Gt("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(M,s.VALIDATE_STATUS)+`
...
}`;class Jp{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(t,e){if(this.texture===null){const n=new ml(t.texture);(t.depthNear!==e.depthNear||t.depthFar!==e.depthFar)&&(this.depthNear=t.depthNear,this.depthFar=t.depthFar),this.texture=n}}getMesh(t){if(this.texture!==null&&this.mesh===null){const e=t.cameras[0].viewport,n=new an({vertexShader:Zp,fragmentShader:$p,uniforms:{depthColor:{value:this.texture},depthWidth:{value:e.z},depthHeight:{value:e.w}}});this.mesh=new Ee(new ws(20,20),n)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class Qp extends Xn{constructor(t,e){super();const n=this;let s=null,r=1,a=null,o="local-floor",c=1,l=null,u=null,d=null,f=null,_=null,v=null;const M=typeof XRWebGLBinding<"u",p=new Jp,h={},A=e.getContextAttributes();let w=null,E=null;const T=[],b=[],C=new Ct;let F=null;const g=new Be;g.viewport=new le;const S=new Be;S.viewport=new le;const D=[g,S],z=new ah;let O=null,H=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(q){let $=T[q];return $===void 0&&($=new nr,T[q]=$),$.getTargetRaySpace()},this.getControllerGrip=function(q){let $=T[q];return $===void 0&&($=new nr,T[q]=$),$.getGripSpace()},this.getHand=function(q){let $=T[q];return $===void 0&&($=new nr,T[q]=$),$.getHandSpace()};function Y(q){const $=b.indexOf(q.inputSource);if($===-1)return;const pt=T[$];pt!==void 0&&(pt.update(q.inputSource,q.frame,l||a),pt.dispatchEvent({type:q.type,data:q.inputSource}))}function G(){s.removeEventListener("select",Y),s.removeEventListener("selectstart",Y),s.removeEventListener("selectend",Y),s.removeEventListener("squeeze",Y),s.removeEventListener("squeezestart",Y),s.removeEventListener("squeezeend",Y),s.removeEventListener("end",G),s.removeEventListener("inputsourceschange",W);for(let q=0;q<T.length;q++){const $=b[q];$!==null&&(b[q]=null,T[q].disconnect($))}O=null,H=null,p.reset();for(const q in h)delete h[q];t.setRenderTarget(w),_=null,f=null,d=null,s=null,E=null,ie.stop(),n.isPresenting=!1,t.setPixelRatio(F),t.setSize(C.width,C.height,!1),n.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(q){r=q,n.isPresenting===!0&&wt("WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(q){o=q,n.isPresenting===!0&&wt("WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return l||a},this.setReferenceSpace=function(q){l=q},this.getBaseLayer=function(){return f!==null?f:_},this.getBinding=function(){return d===null&&M&&(d=new XRWebGLBinding(s,e)),d},this.getFrame=function(){return v},this.getSession=function(){return s},this.setSession=async function(q){if(s=q,s!==null){if(w=t.getRenderTarget(),s.addEventListener("select",Y),s.addEventListener("selectstart",Y),s.addEventListener("selectend",Y),s.addEventListener("squeeze",Y),s.addEventListener("squeezestart",Y),s.addEventListener("squeezeend",Y),s.addEventListener("end",G),s.addEventListener("inputsourceschange",W),A.xrCompatible!==!0&&await e.makeXRCompatible(),F=t.getPixelRatio(),t.getSize(C),M&&"createProjectionLayer"in XRWebGLBinding.prototype){let pt=null,Pt=null,gt=null;A.depth&&(gt=A.stencil?e.DEPTH24_STENCIL8:e.DEPTH_COMPONENT24,pt=A.stencil?Hn:vn,Pt=A.stencil?Pi:sn);const kt={colorFormat:e.RGBA8,depthFormat:gt,scaleFactor:r};d=this.getBinding(),f=d.createProjectionLayer(kt),s.updateRenderState({layers:[f]}),t.setPixelRatio(1),t.setSize(f.textureWidth,f.textureHeight,!1),E=new en(f.textureWidth,f.textureHeight,{format:qe,type:ze,depthTexture:new Li(f.textureWidth,f.textureHeight,Pt,void 0,void 0,void 0,void 0,void 0,void 0,pt),stencilBuffer:A.stencil,colorSpace:t.outputColorSpace,samples:A.antialias?4:0,resolveDepthBuffer:f.ignoreDepthValues===!1,resolveStencilBuffer:f.ignoreDepthValues===!1})}else{const pt={antialias:A.antialias,alpha:!0,depth:A.depth,stencil:A.stencil,framebufferScaleFactor:r};_=new XRWebGLLayer(s,e,pt),s.updateRenderState({baseLayer:_}),t.setPixelRatio(1),t.setSize(_.framebufferWidth,_.framebufferHeight,!1),E=new en(_.framebufferWidth,_.framebufferHeight,{format:qe,type:ze,colorSpace:t.outputColorSpace,stencilBuffer:A.stencil,resolveDepthBuffer:_.ignoreDepthValues===!1,resolveStencilBuffer:_.ignoreDepthValues===!1})}E.isXRRenderTarget=!0,this.setFoveation(c),l=null,a=await s.requestReferenceSpace(o),ie.setContext(s),ie.start(),n.isPresenting=!0,n.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(s!==null)return s.environmentBlendMode},this.getDepthTexture=function(){return p.getDepthTexture()};function W(q){for(let $=0;$<q.removed.length;$++){const pt=q.removed[$],Pt=b.indexOf(pt);Pt>=0&&(b[Pt]=null,T[Pt].disconnect(pt))}for(let $=0;$<q.added.length;$++){const pt=q.added[$];let Pt=b.indexOf(pt);if(Pt===-1){for(let kt=0;kt<T.length;kt++)if(kt>=b.length){b.push(pt),Pt=kt;break}else if(b[kt]===null){b[kt]=pt,Pt=kt;break}if(Pt===-1)break}const gt=T[Pt];gt&&gt.connect(pt)}}const Z=new U,ht=new U;function at(q,$,pt){Z.setFromMatrixPosition($.matrixWorld),ht.setFromMatrixPosition(pt.matrixWorld);const Pt=Z.distanceTo(ht),gt=$.projectionMatrix.elements,kt=pt.projectionMatrix.elements,me=gt[14]/(gt[10]-1),Vt=gt[14]/(gt[10]+1),Yt=(gt[9]+1)/gt[5],Jt=(gt[9]-1)/gt[5],Ut=(gt[8]-1)/gt[0],ce=(kt[8]+1)/kt[0],R=me*Ut,he=me*ce,Xt=Pt/(-Ut+ce),te=Xt*-Ut;if($.matrixWorld.decompose(q.position,q.quaternion,q.scale),q.translateX(te),q.translateZ(Xt),q.matrixWorld.compose(q.position,q.quaternion,q.scale),q.matrixWorldInverse.copy(q.matrixWorld).invert(),gt[10]===-1)q.projectionMatrix.copy($.projectionMatrix),q.projectionMatrixInverse.copy($.projectionMatrixInverse);else{const vt=me+Xt,y=Vt+Xt,m=R-te,L=he+(Pt-te),X=Yt*Vt/y*vt,K=Jt*Vt/y*vt;q.projectionMatrix.makePerspective(m,L,X,K,vt,y),q.projectionMatrixInverse.copy(q.projectionMatrix).invert()}}function ut(q,$){$===null?q.matrixWorld.copy(q.matrix):q.matrixWorld.multiplyMatrices($.matrixWorld,q.matrix),q.matrixWorldInverse.copy(q.matrixWorld).invert()}this.updateCamera=function(q){if(s===null)return;let $=q.near,pt=q.far;p.texture!==null&&(p.depthNear>0&&($=p.depthNear),p.depthFar>0&&(pt=p.depthFar)),z.near=S.near=g.near=$,z.far=S.far=g.far=pt,(O!==z.near||H!==z.far)&&(s.updateRenderState({depthNear:z.near,depthFar:z.far}),O=z.near,H=z.far),z.layers.mask=q.layers.mask|6,g.layers.mask=z.layers.mask&3,S.layers.mask=z.layers.mask&5;const Pt=q.parent,gt=z.cameras;ut(z,Pt);for(let kt=0;kt<gt.length;kt++)ut(gt[kt],Pt);gt.length===2?at(z,g,S):z.projectionMatrix.copy(g.projectionMatrix),Ft(q,z,Pt)};function Ft(q,$,pt){pt===null?q.matrix.copy($.matrixWorld):(q.matrix.copy(pt.matrixWorld),q.matrix.invert(),q.matrix.multiply($.matrixWorld)),q.matrix.decompose(q.position,q.quaternion,q.scale),q.updateMatrixWorld(!0),q.projectionMatrix.copy($.projectionMatrix),q.projectionMatrixInverse.copy($.projectionMatrixInverse),q.isPerspectiveCamera&&(q.fov=aa*2*Math.atan(1/q.projectionMatrix.elements[5]),q.zoom=1)}this.getCamera=function(){return z},this.getFoveation=function(){if(!(f===null&&_===null))return c},this.setFoveation=function(q){c=q,f!==null&&(f.fixedFoveation=q),_!==null&&_.fixedFoveation!==void 0&&(_.fixedFoveation=q)},this.hasDepthSensing=function(){return p.texture!==null},this.getDepthSensingMesh=function(){return p.getMesh(z)},this.getCameraTexture=function(q){return h[q]};let It=null;function re(q,$){if(u=$.getViewerPose(l||a),v=$,u!==null){const pt=u.views;_!==null&&(t.setRenderTargetFramebuffer(E,_.framebuffer),t.setRenderTarget(E));let Pt=!1;pt.length!==z.cameras.length&&(z.cameras.length=0,Pt=!0);for(let Vt=0;Vt<pt.length;Vt++){const Yt=pt[Vt];let Jt=null;if(_!==null)Jt=_.getViewport(Yt);else{const ce=d.getViewSubImage(f,Yt);Jt=ce.viewport,Vt===0&&(t.setRenderTargetTextures(E,ce.colorTexture,ce.depthStencilTexture),t.setRenderTarget(E))}let Ut=D[Vt];Ut===void 0&&(Ut=new Be,Ut.layers.enable(Vt),Ut.viewport=new le,D[Vt]=Ut),Ut.matrix.fromArray(Yt.transform.matrix),Ut.matrix.decompose(Ut.position,Ut.quaternion,Ut.scale),Ut.projectionMatrix.fromArray(Yt.projectionMatrix),Ut.projectionMatrixInverse.copy(Ut.projectionMatrix).invert(),Ut.viewport.set(Jt.x,Jt.y,Jt.width,Jt.height),Vt===0&&(z.matrix.copy(Ut.matrix),z.matrix.decompose(z.position,z.quaternion,z.scale)),Pt===!0&&z.cameras.push(Ut)}const gt=s.enabledFeatures;if(gt&&gt.includes("depth-sensing")&&s.depthUsage=="gpu-optimized"&&M){d=n.getBinding();const Vt=d.getDepthInformation(pt[0]);Vt&&Vt.isValid&&Vt.texture&&p.init(Vt,s.renderState)}if(gt&&gt.includes("camera-access")&&M){t.state.unbindTexture(),d=n.getBinding();for(let Vt=0;Vt<pt.length;Vt++){const Yt=pt[Vt].camera;if(Yt){let Jt=h[Yt];Jt||(Jt=new ml,h[Yt]=Jt);const Ut=d.getCameraImage(Yt);Jt.sourceTexture=Ut}}}}for(let pt=0;pt<T.length;pt++){const Pt=b[pt],gt=T[pt];Pt!==null&&gt!==void 0&&gt.update(Pt,$,l||a)}It&&It(q,$),$.detectedPlanes&&n.dispatchEvent({type:"planesdetected",data:$}),v=null}const ie=new gl;ie.setAnimationLoop(re),this.setAnimationLoop=function(q){It=q},this.dispose=function(){}}}const Bn=new rn,tm=new se;function em(i,t){function e(p,h){p.matrixAutoUpdate===!0&&p.updateMatrix(),h.value.copy(p.matrix)}function n(p,h){h.color.getRGB(p.fogColor.value,cl(i)),h.isFog?(p.fogNear.value=h.near,p.fogFar.value=h.far):h.isFogExp2&&(p.fogDensity.value=h.density)}function s(p,h,A,w,E){h.isMeshBasicMaterial||h.isMeshLambertMaterial?r(p,h):h.isMeshToonMaterial?(r(p,h),d(p,h)):h.isMeshPhongMaterial?(r(p,h),u(p,h)):h.isMeshStandardMaterial?(r(p,h),f(p,h),h.isMeshPhysicalMaterial&&_(p,h,E)):h.isMeshMatcapMaterial?(r(p,h),v(p,h)):h.isMeshDepthMaterial?r(p,h):h.isMeshDistanceMaterial?(r(p,h),M(p,h)):h.isMeshNormalMaterial?r(p,h):h.isLineBasicMaterial?(a(p,h),h.isLineDashedMaterial&&o(p,h)):h.isPointsMaterial?c(p,h,A,w):h.isSpriteMaterial?l(p,h):h.isShadowMaterial?(p.color.value.copy(h.color),p.opacity.value=h.opacity):h.isShaderMaterial&&(h.uniformsNeedUpdate=!1)}function r(p,h){p.opacity.value=h.opacity,h.color&&p.diffuse.value.copy(h.color),h.emissive&&p.emissive.value.copy(h.emissive).multiplyScalar(h.emissiveIntensity),h.map&&(p.map.value=h.map,e(h.map,p.mapTransform)),h.alphaMap&&(p.alphaMap.value=h.alphaMap,e(h.alphaMap,p.alphaMapTransform)),h.bumpMap&&(p.bumpMap.value=h.bumpMap,e(h.bumpMap,p.bumpMapTransform),p.bumpScale.value=h.bumpScale,h.side===ge&&(p.bumpScale.value*=-1)),h.normalMap&&(p.normalMap.value=h.normalMap,e(h.normalMap,p.normalMapTransform),p.normalScale.value.copy(h.normalScale),h.side===ge&&p.normalScale.value.negate()),h.displacementMap&&(p.displacementMap.value=h.displacementMap,e(h.displacementMap,p.displacementMapTransform),p.displacementScale.value=h.displacementScale,p.displacementBias.value=h.displacementBias),h.emissiveMap&&(p.emissiveMap.value=h.emissiveMap,e(h.emissiveMap,p.emissiveMapTransform)),h.specularMap&&(p.specularMap.value=h.specularMap,e(h.specularMap,p.specularMapTransform)),h.alphaTest>0&&(p.alphaTest.value=h.alphaTest);const A=t.get(h),w=A.envMap,E=A.envMapRotation;w&&(p.envMap.value=w,Bn.copy(E),Bn.x*=-1,Bn.y*=-1,Bn.z*=-1,w.isCubeTexture&&w.isRenderTargetTexture===!1&&(Bn.y*=-1,Bn.z*=-1),p.envMapRotation.value.setFromMatrix4(tm.makeRotationFromEuler(Bn)),p.flipEnvMap.value=w.isCubeTexture&&w.isRenderTargetTexture===!1?-1:1,p.reflectivity.value=h.reflectivity,p.ior.value=h.ior,p.refractionRatio.value=h.refractionRatio),h.lightMap&&(p.lightMap.value=h.lightMap,p.lightMapIntensity.value=h.lightMapIntensity,e(h.lightMap,p.lightMapTransform)),h.aoMap&&(p.aoMap.value=h.aoMap,p.aoMapIntensity.value=h.aoMapIntensity,e(h.aoMap,p.aoMapTransform))}function a(p,h){p.diffuse.value.copy(h.color),p.opacity.value=h.opacity,h.map&&(p.map.value=h.map,e(h.map,p.mapTransform))}function o(p,h){p.dashSize.value=h.dashSize,p.totalSize.value=h.dashSize+h.gapSize,p.scale.value=h.scale}function c(p,h,A,w){p.diffuse.value.copy(h.color),p.opacity.value=h.opacity,p.size.value=h.size*A,p.scale.value=w*.5,h.map&&(p.map.value=h.map,e(h.map,p.uvTransform)),h.alphaMap&&(p.alphaMap.value=h.alphaMap,e(h.alphaMap,p.alphaMapTransform)),h.alphaTest>0&&(p.alphaTest.value=h.alphaTest)}function l(p,h){p.diffuse.value.copy(h.color),p.opacity.value=h.opacity,p.rotation.value=h.rotation,h.map&&(p.map.value=h.map,e(h.map,p.mapTransform)),h.alphaMap&&(p.alphaMap.value=h.alphaMap,e(h.alphaMap,p.alphaMapTransform)),h.alphaTest>0&&(p.alphaTest.value=h.alphaTest)}function u(p,h){p.specular.value.copy(h.specular),p.shininess.value=Math.max(h.shininess,1e-4)}function d(p,h){h.gradientMap&&(p.gradientMap.value=h.gradientMap)}function f(p,h){p.metalness.value=h.metalness,h.metalnessMap&&(p.metalnessMap.value=h.metalnessMap,e(h.metalnessMap,p.metalnessMapTransform)),p.roughness.value=h.roughness,h.roughnessMap&&(p.roughnessMap.value=h.roughnessMap,e(h.roughnessMap,p.roughnessMapTransform)),h.envMap&&(p.envMapIntensity.value=h.envMapIntensity)}function _(p,h,A){p.ior.value=h.ior,h.sheen>0&&(p.sheenColor.value.copy(h.sheenColor).multiplyScalar(h.sheen),p.sheenRoughness.value=h.sheenRoughness,h.sheenColorMap&&(p.sheenColorMap.value=h.sheenColorMap,e(h.sheenColorMap,p.sheenColorMapTransform)),h.sheenRoughnessMap&&(p.sheenRoughnessMap.value=h.sheenRoughnessMap,e(h.sheenRoughnessMap,p.sheenRoughnessMapTransform))),h.clearcoat>0&&(p.clearcoat.value=h.clearcoat,p.clearcoatRoughness.value=h.clearcoatRoughness,h.clearcoatMap&&(p.clearcoatMap.value=h.clearcoatMap,e(h.clearcoatMap,p.clearcoatMapTransform)),h.clearcoatRoughnessMap&&(p.clearcoatRoughnessMap.value=h.clearcoatRoughnessMap,e(h.clearcoatRoughnessMap,p.clearcoatRoughnessMapTransform)),h.clearcoatNormalMap&&(p.clearcoatNormalMap.value=h.clearcoatNormalMap,e(h.clearcoatNormalMap,p.clearcoatNormalMapTransform),p.clearcoatNormalScale.value.copy(h.clearcoatNormalScale),h.side===ge&&p.clearcoatNormalScale.value.negate())),h.dispersion>0&&(p.dispersion.value=h.dispersion),h.iridescence>0&&(p.iridescence.value=h.iridescence,p.iridescenceIOR.value=h.iridescenceIOR,p.iridescenceThicknessMinimum.value=h.iridescenceThicknessRange[0],p.iridescenceThicknessMaximum.value=h.iridescenceThicknessRange[1],h.iridescenceMap&&(p.iridescenceMap.value=h.iridescenceMap,e(h.iridescenceMap,p.iridescenceMapTransform)),h.iridescenceThicknessMap&&(p.iridescenceThicknessMap.value=h.iridescenceThicknessMap,e(h.iridescenceThicknessMap,p.iridescenceThicknessMapTransform))),h.transmission>0&&(p.transmission.value=h.transmission,p.transmissionSamplerMap.value=A.texture,p.transmissionSamplerSize.value.set(A.width,A.height),h.transmissionMap&&(p.transmissionMap.value=h.transmissionMap,e(h.transmissionMap,p.transmissionMapTransform)),p.thickness.value=h.thickness,h.thicknessMap&&(p.thicknessMap.value=h.thicknessMap,e(h.thicknessMap,p.thicknessMapTransform)),p.attenuationDistance.value=h.attenuationDistance,p.attenuationColor.value.copy(h.attenuationColor)),h.anisotropy>0&&(p.anisotropyVector.value.set(h.anisotropy*Math.cos(h.anisotropyRotation),h.anisotropy*Math.sin(h.anisotropyRotation)),h.anisotropyMap&&(p.anisotropyMap.value=h.anisotropyMap,e(h.anisotropyMap,p.anisotropyMapTransform))),p.specularIntensity.value=h.specularIntensity,p.specularColor.value.copy(h.specularColor),h.specularColorMap&&(p.specularColorMap.value=h.specularColorMap,e(h.specularColorMap,p.specularColorMapTransform)),h.specularIntensityMap&&(p.specularIntensityMap.value=h.specularIntensityMap,e(h.specularIntensityMap,p.specularIntensityMapTransform))}function v(p,h){h.matcap&&(p.matcap.value=h.matcap)}function M(p,h){const A=t.get(h).light;p.referencePosition.value.setFromMatrixPosition(A.matrixWorld),p.nearDistance.value=A.shadow.camera.near,p.farDistance.value=A.shadow.camera.far}return{refreshFogUniforms:n,refreshMaterialUniforms:s}}function nm(i,t,e,n){let s={},r={},a=[];const o=i.getParameter(i.MAX_UNIFORM_BUFFER_BINDINGS);function c(A,w){const E=w.program;n.uniformBlockBinding(A,E)}function l(A,w){let E=s[A.id];E===void 0&&(v(A),E=u(A),s[A.id]=E,A.addEventListener("dispose",p));const T=w.program;n.updateUBOMapping(A,T);const b=t.render.frame;r[A.id]!==b&&(f(A),r[A.id]=b)}function u(A){const w=d();A.__bindingPointIndex=w;const E=i.createBuffer(),T=A.__size,b=A.usage;return i.bindBuffer(i.UNIFORM_BUFFER,E),i.bufferData(i.UNIFORM_BUFFER,T,b),i.bindBuffer(i.UNIFORM_BUFFER,null),i.bindBufferBase(i.UNIFORM_BUFFER,w,E),E}function d(){for(let A=0;A<o;A++)if(a.indexOf(A)===-1)return a.push(A),A;return Gt("WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function f(A){const w=s[A.id],E=A.uniforms,T=A.__cache;i.bindBuffer(i.UNIFORM_BUFFER,w);for(let b=0,C=E.length;b<C;b++){const F=Array.isArray(E[b])?E[b]:[E[b]];for(let g=0,S=F.length;g<S;g++){const D=F[g];if(_(D,b,g,T)===!0){const z=D.__offset,O=Array.isArray(D.value)?D.value:[D.value];let H=0;for(let Y=0;Y<O.length;Y++){const G=O[Y],W=M(G);typeof G=="number"||typeof G=="boolean"?(D.__data[0]=G,i.bufferSubData(i.UNIFORM_BUFFER,z+H,D.__data)):G.isMatrix3?(D.__data[0]=G.elements[0],D.__data[1]=G.elements[1],D.__data[2]=G.elements[2],D.__data[3]=0,D.__data[4]=G.elements[3],D.__data[5]=G.elements[4],D.__data[6]=G.elements[5],D.__data[7]=0,D.__data[8]=G.elements[6],D.__data[9]=G.elements[7],D.__data[10]=G.elements[8],D.__data[11]=0):(G.toArray(D.__data,H),H+=W.storage/Float32Array.BYTES_PER_ELEMENT)}i.bufferSubData(i.UNIFORM_BUFFER,z,D.__data)}}}i.bindBuffer(i.UNIFORM_BUFFER,null)}function _(A,w,E,T){const b=A.value,C=w+"_"+E;if(T[C]===void 0)return typeof b=="number"||typeof b=="boolean"?T[C]=b:T[C]=b.clone(),!0;{const F=T[C];if(typeof b=="number"||typeof b=="boolean"){if(F!==b)return T[C]=b,!0}else if(F.equals(b)===!1)return F.copy(b),!0}return!1}function v(A){const w=A.uniforms;let E=0;const T=16;for(let C=0,F=w.length;C<F;C++){const g=Array.isArray(w[C])?w[C]:[w[C]];for(let S=0,D=g.length;S<D;S++){const z=g[S],O=Array.isArray(z.value)?z.value:[z.value];for(let H=0,Y=O.length;H<Y;H++){const G=O[H],W=M(G),Z=E%T,ht=Z%W.boundary,at=Z+ht;E+=ht,at!==0&&T-at<W.storage&&(E+=T-at),z.__data=new Float32Array(W.storage/Float32Array.BYTES_PER_ELEMENT),z.__offset=E,E+=W.storage}}}const b=E%T;return b>0&&(E+=T-b),A.__size=E,A.__cache={},this}function M(A){const w={boundary:0,storage:0};return typeof A=="number"||typeof A=="boolean"?(w.boundary=4,w.storage=4):A.isVector2?(w.boundary=8,w.storage=8):A.isVector3||A.isColor?(w.boundary=16,w.storage=12):A.isVector4?(w.boundary=16,w.storage=16):A.isMatrix3?(w.boundary=48,w.storage=48):A.isMatrix4?(w.boundary=64,w.storage=64):A.isTexture?wt("WebGLRenderer: Texture samplers can not be part of an uniforms group."):wt("WebGLRenderer: Unsupported uniform value type.",A),w}function p(A){const w=A.target;w.removeEventListener("dispose",p);const E=a.indexOf(w.__bindingPointIndex);a.splice(E,1),i.deleteBuffer(s[w.id]),delete s[w.id],delete r[w.id]}function h(){for(const A in s)i.deleteBuffer(s[A]);a=[],s={},r={}}return{bind:c,update:l,dispose:h}}const im=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]);let Ke=null;function sm(){return Ke===null&&(Ke=new kc(im,16,16,pi,xn),Ke.name="DFG_LUT",Ke.minFilter=ye,Ke.magFilter=ye,Ke.wrapS=pn,Ke.wrapT=pn,Ke.generateMipmaps=!1,Ke.needsUpdate=!0),Ke}class rm{constructor(t={}){const{canvas:e=mc(),context:n=null,depth:s=!0,stencil:r=!1,alpha:a=!1,antialias:o=!1,premultipliedAlpha:c=!0,preserveDrawingBuffer:l=!1,powerPreference:u="default",failIfMajorPerformanceCaveat:d=!1,reversedDepthBuffer:f=!1,outputBufferType:_=ze}=t;this.isWebGLRenderer=!0;let v;if(n!==null){if(typeof WebGLRenderingContext<"u"&&n instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");v=n.getContextAttributes().alpha}else v=a;const M=_,p=new Set([xa,ga,_a]),h=new Set([ze,sn,Ci,Pi,pa,ma]),A=new Uint32Array(4),w=new Int32Array(4);let E=null,T=null;const b=[],C=[];let F=null;this.domElement=e,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=tn,this.toneMappingExposure=1,this.transmissionResolutionScale=1;const g=this;let S=!1;this._outputColorSpace=He;let D=0,z=0,O=null,H=-1,Y=null;const G=new le,W=new le;let Z=null;const ht=new zt(0);let at=0,ut=e.width,Ft=e.height,It=1,re=null,ie=null;const q=new le(0,0,ut,Ft),$=new le(0,0,ut,Ft);let pt=!1;const Pt=new ya;let gt=!1,kt=!1;const me=new se,Vt=new U,Yt=new le,Jt={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let Ut=!1;function ce(){return O===null?It:1}let R=n;function he(x,I){return e.getContext(x,I)}try{const x={alpha:!0,depth:s,stencil:r,antialias:o,premultipliedAlpha:c,preserveDrawingBuffer:l,powerPreference:u,failIfMajorPerformanceCaveat:d};if("setAttribute"in e&&e.setAttribute("data-engine",`three.js r${ua}`),e.addEventListener("webglcontextlost",Rt,!1),e.addEventListener("webglcontextrestored",ee,!1),e.addEventListener("webglcontextcreationerror",qt,!1),R===null){const I="webgl2";if(R=he(I,x),R===null)throw he(I)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(x){throw Gt("WebGLRenderer: "+x.message),x}let Xt,te,vt,y,m,L,X,K,k,St,nt,xt,At,Q,st,_t,Mt,it,Nt,P,ct,tt,dt,J;function j(){Xt=new sf(R),Xt.init(),tt=new Kp(R,Xt),te=new jd(R,Xt,t,tt),vt=new qp(R,Xt),te.reversedDepthBuffer&&f&&vt.buffers.depth.setReversed(!0),y=new of(R),m=new Lp,L=new jp(R,Xt,vt,m,te,tt,y),X=new Zd(g),K=new nf(g),k=new hh(R),dt=new Yd(R,k),St=new rf(R,k,y,dt),nt=new cf(R,St,k,y),Nt=new lf(R,te,L),_t=new Kd(m),xt=new Dp(g,X,K,Xt,te,dt,_t),At=new em(g,m),Q=new Up,st=new Vp(Xt),it=new Xd(g,X,K,vt,nt,v,c),Mt=new Xp(g,nt,te),J=new nm(R,y,te,vt),P=new qd(R,Xt,y),ct=new af(R,Xt,y),y.programs=xt.programs,g.capabilities=te,g.extensions=Xt,g.properties=m,g.renderLists=Q,g.shadowMap=Mt,g.state=vt,g.info=y}j(),M!==ze&&(F=new uf(M,e.width,e.height,s,r));const et=new Qp(g,R);this.xr=et,this.getContext=function(){return R},this.getContextAttributes=function(){return R.getContextAttributes()},this.forceContextLoss=function(){const x=Xt.get("WEBGL_lose_context");x&&x.loseContext()},this.forceContextRestore=function(){const x=Xt.get("WEBGL_lose_context");x&&x.restoreContext()},this.getPixelRatio=function(){return It},this.setPixelRatio=function(x){x!==void 0&&(It=x,this.setSize(ut,Ft,!1))},this.getSize=function(x){return x.set(ut,Ft)},this.setSize=function(x,I,V=!0){if(et.isPresenting){wt("WebGLRenderer: Can't change size while VR device is presenting.");return}ut=x,Ft=I,e.width=Math.floor(x*It),e.height=Math.floor(I*It),V===!0&&(e.style.width=x+"px",e.style.height=I+"px"),F!==null&&F.setSize(e.width,e.height),this.setViewport(0,0,x,I)},this.getDrawingBufferSize=function(x){return x.set(ut*It,Ft*It).floor()},this.setDrawingBufferSize=function(x,I,V){ut=x,Ft=I,It=V,e.width=Math.floor(x*V),e.height=Math.floor(I*V),this.setViewport(0,0,x,I)},this.setEffects=function(x){if(M===ze){console.error("THREE.WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.");return}if(x){for(let I=0;I<x.length;I++)if(x[I].isOutputPass===!0){console.warn("THREE.WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.");break}}F.setEffects(x||[])},this.getCurrentViewport=function(x){return x.copy(G)},this.getViewport=function(x){return x.copy(q)},this.setViewport=function(x,I,V,B){x.isVector4?q.set(x.x,x.y,x.z,x.w):q.set(x,I,V,B),vt.viewport(G.copy(q).multiplyScalar(It).round())},this.getScissor=function(x){return x.copy($)},this.setScissor=function(x,I,V,B){x.isVector4?$.set(x.x,x.y,x.z,x.w):$.set(x,I,V,B),vt.scissor(W.copy($).multiplyScalar(It).round())},this.getScissorTest=function(){return pt},this.setScissorTest=function(x){vt.setScissorTest(pt=x)},this.setOpaqueSort=function(x){re=x},this.setTransparentSort=function(x){ie=x},this.getClearColor=function(x){return x.copy(it.getClearColor())},this.setClearColor=function(){it.setClearColor(...arguments)},this.getClearAlpha=function(){return it.getClearAlpha()},this.setClearAlpha=function(){it.setClearAlpha(...arguments)},this.clear=function(x=!0,I=!0,V=!0){let B=0;if(x){let N=!1;if(O!==null){const rt=O.texture.format;N=p.has(rt)}if(N){const rt=O.texture.type,ft=h.has(rt),lt=it.getClearColor(),mt=it.getClearAlpha(),Et=lt.r,bt=lt.g,yt=lt.b;ft?(A[0]=Et,A[1]=bt,A[2]=yt,A[3]=mt,R.clearBufferuiv(R.COLOR,0,A)):(w[0]=Et,w[1]=bt,w[2]=yt,w[3]=mt,R.clearBufferiv(R.COLOR,0,w))}else B|=R.COLOR_BUFFER_BIT}I&&(B|=R.DEPTH_BUFFER_BIT),V&&(B|=R.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),R.clear(B)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){e.removeEventListener("webglcontextlost",Rt,!1),e.removeEventListener("webglcontextrestored",ee,!1),e.removeEventListener("webglcontextcreationerror",qt,!1),it.dispose(),Q.dispose(),st.dispose(),m.dispose(),X.dispose(),K.dispose(),nt.dispose(),dt.dispose(),J.dispose(),xt.dispose(),et.dispose(),et.removeEventListener("sessionstart",wa),et.removeEventListener("sessionend",Ra),Dn.stop()};function Rt(x){x.preventDefault(),Ha("WebGLRenderer: Context Lost."),S=!0}function ee(){Ha("WebGLRenderer: Context Restored."),S=!1;const x=y.autoReset,I=Mt.enabled,V=Mt.autoUpdate,B=Mt.needsUpdate,N=Mt.type;j(),y.autoReset=x,Mt.enabled=I,Mt.autoUpdate=V,Mt.needsUpdate=B,Mt.type=N}function qt(x){Gt("WebGLRenderer: A WebGL context could not be created. Reason: ",x.statusMessage)}function je(x){const I=x.target;I.removeEventListener("dispose",je),on(I)}function on(x){yl(x),m.remove(x)}function yl(x){const I=m.get(x).programs;I!==void 0&&(I.forEach(function(V){xt.releaseProgram(V)}),x.isShaderMaterial&&xt.releaseShaderCache(x))}this.renderBufferDirect=function(x,I,V,B,N,rt){I===null&&(I=Jt);const ft=N.isMesh&&N.matrixWorld.determinant()<0,lt=bl(x,I,V,B,N);vt.setMaterial(B,ft);let mt=V.index,Et=1;if(B.wireframe===!0){if(mt=St.getWireframeAttribute(V),mt===void 0)return;Et=2}const bt=V.drawRange,yt=V.attributes.position;let Ot=bt.start*Et,Zt=(bt.start+bt.count)*Et;rt!==null&&(Ot=Math.max(Ot,rt.start*Et),Zt=Math.min(Zt,(rt.start+rt.count)*Et)),mt!==null?(Ot=Math.max(Ot,0),Zt=Math.min(Zt,mt.count)):yt!=null&&(Ot=Math.max(Ot,0),Zt=Math.min(Zt,yt.count));const ae=Zt-Ot;if(ae<0||ae===1/0)return;dt.setup(N,B,lt,V,mt);let oe,Qt=P;if(mt!==null&&(oe=k.get(mt),Qt=ct,Qt.setIndex(oe)),N.isMesh)B.wireframe===!0?(vt.setLineWidth(B.wireframeLinewidth*ce()),Qt.setMode(R.LINES)):Qt.setMode(R.TRIANGLES);else if(N.isLine){let Tt=B.linewidth;Tt===void 0&&(Tt=1),vt.setLineWidth(Tt*ce()),N.isLineSegments?Qt.setMode(R.LINES):N.isLineLoop?Qt.setMode(R.LINE_LOOP):Qt.setMode(R.LINE_STRIP)}else N.isPoints?Qt.setMode(R.POINTS):N.isSprite&&Qt.setMode(R.TRIANGLES);if(N.isBatchedMesh)if(N._multiDrawInstances!==null)Di("WebGLRenderer: renderMultiDrawInstances has been deprecated and will be removed in r184. Append to renderMultiDraw arguments and use indirection."),Qt.renderMultiDrawInstances(N._multiDrawStarts,N._multiDrawCounts,N._multiDrawCount,N._multiDrawInstances);else if(Xt.get("WEBGL_multi_draw"))Qt.renderMultiDraw(N._multiDrawStarts,N._multiDrawCounts,N._multiDrawCount);else{const Tt=N._multiDrawStarts,jt=N._multiDrawCounts,Wt=N._multiDrawCount,Ue=mt?k.get(mt).bytesPerElement:1,qn=m.get(B).currentProgram.getUniforms();for(let Ne=0;Ne<Wt;Ne++)qn.setValue(R,"_gl_DrawID",Ne),Qt.render(Tt[Ne]/Ue,jt[Ne])}else if(N.isInstancedMesh)Qt.renderInstances(Ot,ae,N.count);else if(V.isInstancedBufferGeometry){const Tt=V._maxInstanceCount!==void 0?V._maxInstanceCount:1/0,jt=Math.min(V.instanceCount,Tt);Qt.renderInstances(Ot,ae,jt)}else Qt.render(Ot,ae)};function Aa(x,I,V){x.transparent===!0&&x.side===$e&&x.forceSinglePass===!1?(x.side=ge,x.needsUpdate=!0,zi(x,I,V),x.side=Pn,x.needsUpdate=!0,zi(x,I,V),x.side=$e):zi(x,I,V)}this.compile=function(x,I,V=null){V===null&&(V=x),T=st.get(V),T.init(I),C.push(T),V.traverseVisible(function(N){N.isLight&&N.layers.test(I.layers)&&(T.pushLight(N),N.castShadow&&T.pushShadow(N))}),x!==V&&x.traverseVisible(function(N){N.isLight&&N.layers.test(I.layers)&&(T.pushLight(N),N.castShadow&&T.pushShadow(N))}),T.setupLights();const B=new Set;return x.traverse(function(N){if(!(N.isMesh||N.isPoints||N.isLine||N.isSprite))return;const rt=N.material;if(rt)if(Array.isArray(rt))for(let ft=0;ft<rt.length;ft++){const lt=rt[ft];Aa(lt,V,N),B.add(lt)}else Aa(rt,V,N),B.add(rt)}),T=C.pop(),B},this.compileAsync=function(x,I,V=null){const B=this.compile(x,I,V);return new Promise(N=>{function rt(){if(B.forEach(function(ft){m.get(ft).currentProgram.isReady()&&B.delete(ft)}),B.size===0){N(x);return}setTimeout(rt,10)}Xt.get("KHR_parallel_shader_compile")!==null?rt():setTimeout(rt,10)})};let Ps=null;function Tl(x){Ps&&Ps(x)}function wa(){Dn.stop()}function Ra(){Dn.start()}const Dn=new gl;Dn.setAnimationLoop(Tl),typeof self<"u"&&Dn.setContext(self),this.setAnimationLoop=function(x){Ps=x,et.setAnimationLoop(x),x===null?Dn.stop():Dn.start()},et.addEventListener("sessionstart",wa),et.addEventListener("sessionend",Ra),this.render=function(x,I){if(I!==void 0&&I.isCamera!==!0){Gt("WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(S===!0)return;const V=et.enabled===!0&&et.isPresenting===!0,B=F!==null&&(O===null||V)&&F.begin(g,O);if(x.matrixWorldAutoUpdate===!0&&x.updateMatrixWorld(),I.parent===null&&I.matrixWorldAutoUpdate===!0&&I.updateMatrixWorld(),et.enabled===!0&&et.isPresenting===!0&&(F===null||F.isCompositing()===!1)&&(et.cameraAutoUpdate===!0&&et.updateCamera(I),I=et.getCamera()),x.isScene===!0&&x.onBeforeRender(g,x,I,O),T=st.get(x,C.length),T.init(I),C.push(T),me.multiplyMatrices(I.projectionMatrix,I.matrixWorldInverse),Pt.setFromProjectionMatrix(me,Qe,I.reversedDepth),kt=this.localClippingEnabled,gt=_t.init(this.clippingPlanes,kt),E=Q.get(x,b.length),E.init(),b.push(E),et.enabled===!0&&et.isPresenting===!0){const ft=g.xr.getDepthSensingMesh();ft!==null&&Ds(ft,I,-1/0,g.sortObjects)}Ds(x,I,0,g.sortObjects),E.finish(),g.sortObjects===!0&&E.sort(re,ie),Ut=et.enabled===!1||et.isPresenting===!1||et.hasDepthSensing()===!1,Ut&&it.addToRenderList(E,x),this.info.render.frame++,gt===!0&&_t.beginShadows();const N=T.state.shadowsArray;if(Mt.render(N,x,I),gt===!0&&_t.endShadows(),this.info.autoReset===!0&&this.info.reset(),(B&&F.hasRenderPass())===!1){const ft=E.opaque,lt=E.transmissive;if(T.setupLights(),I.isArrayCamera){const mt=I.cameras;if(lt.length>0)for(let Et=0,bt=mt.length;Et<bt;Et++){const yt=mt[Et];Pa(ft,lt,x,yt)}Ut&&it.render(x);for(let Et=0,bt=mt.length;Et<bt;Et++){const yt=mt[Et];Ca(E,x,yt,yt.viewport)}}else lt.length>0&&Pa(ft,lt,x,I),Ut&&it.render(x),Ca(E,x,I)}O!==null&&z===0&&(L.updateMultisampleRenderTarget(O),L.updateRenderTargetMipmap(O)),B&&F.end(g),x.isScene===!0&&x.onAfterRender(g,x,I),dt.resetDefaultState(),H=-1,Y=null,C.pop(),C.length>0?(T=C[C.length-1],gt===!0&&_t.setGlobalState(g.clippingPlanes,T.state.camera)):T=null,b.pop(),b.length>0?E=b[b.length-1]:E=null};function Ds(x,I,V,B){if(x.visible===!1)return;if(x.layers.test(I.layers)){if(x.isGroup)V=x.renderOrder;else if(x.isLOD)x.autoUpdate===!0&&x.update(I);else if(x.isLight)T.pushLight(x),x.castShadow&&T.pushShadow(x);else if(x.isSprite){if(!x.frustumCulled||Pt.intersectsSprite(x)){B&&Yt.setFromMatrixPosition(x.matrixWorld).applyMatrix4(me);const ft=nt.update(x),lt=x.material;lt.visible&&E.push(x,ft,lt,V,Yt.z,null)}}else if((x.isMesh||x.isLine||x.isPoints)&&(!x.frustumCulled||Pt.intersectsObject(x))){const ft=nt.update(x),lt=x.material;if(B&&(x.boundingSphere!==void 0?(x.boundingSphere===null&&x.computeBoundingSphere(),Yt.copy(x.boundingSphere.center)):(ft.boundingSphere===null&&ft.computeBoundingSphere(),Yt.copy(ft.boundingSphere.center)),Yt.applyMatrix4(x.matrixWorld).applyMatrix4(me)),Array.isArray(lt)){const mt=ft.groups;for(let Et=0,bt=mt.length;Et<bt;Et++){const yt=mt[Et],Ot=lt[yt.materialIndex];Ot&&Ot.visible&&E.push(x,ft,Ot,V,Yt.z,yt)}}else lt.visible&&E.push(x,ft,lt,V,Yt.z,null)}}const rt=x.children;for(let ft=0,lt=rt.length;ft<lt;ft++)Ds(rt[ft],I,V,B)}function Ca(x,I,V,B){const{opaque:N,transmissive:rt,transparent:ft}=x;T.setupLightsView(V),gt===!0&&_t.setGlobalState(g.clippingPlanes,V),B&&vt.viewport(G.copy(B)),N.length>0&&Bi(N,I,V),rt.length>0&&Bi(rt,I,V),ft.length>0&&Bi(ft,I,V),vt.buffers.depth.setTest(!0),vt.buffers.depth.setMask(!0),vt.buffers.color.setMask(!0),vt.setPolygonOffset(!1)}function Pa(x,I,V,B){if((V.isScene===!0?V.overrideMaterial:null)!==null)return;if(T.state.transmissionRenderTarget[B.id]===void 0){const Ot=Xt.has("EXT_color_buffer_half_float")||Xt.has("EXT_color_buffer_float");T.state.transmissionRenderTarget[B.id]=new en(1,1,{generateMipmaps:!0,type:Ot?xn:ze,minFilter:Gn,samples:te.samples,stencilBuffer:r,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:Ht.workingColorSpace})}const rt=T.state.transmissionRenderTarget[B.id],ft=B.viewport||G;rt.setSize(ft.z*g.transmissionResolutionScale,ft.w*g.transmissionResolutionScale);const lt=g.getRenderTarget(),mt=g.getActiveCubeFace(),Et=g.getActiveMipmapLevel();g.setRenderTarget(rt),g.getClearColor(ht),at=g.getClearAlpha(),at<1&&g.setClearColor(16777215,.5),g.clear(),Ut&&it.render(V);const bt=g.toneMapping;g.toneMapping=tn;const yt=B.viewport;if(B.viewport!==void 0&&(B.viewport=void 0),T.setupLightsView(B),gt===!0&&_t.setGlobalState(g.clippingPlanes,B),Bi(x,V,B),L.updateMultisampleRenderTarget(rt),L.updateRenderTargetMipmap(rt),Xt.has("WEBGL_multisampled_render_to_texture")===!1){let Ot=!1;for(let Zt=0,ae=I.length;Zt<ae;Zt++){const oe=I[Zt],{object:Qt,geometry:Tt,material:jt,group:Wt}=oe;if(jt.side===$e&&Qt.layers.test(B.layers)){const Ue=jt.side;jt.side=ge,jt.needsUpdate=!0,Da(Qt,V,B,Tt,jt,Wt),jt.side=Ue,jt.needsUpdate=!0,Ot=!0}}Ot===!0&&(L.updateMultisampleRenderTarget(rt),L.updateRenderTargetMipmap(rt))}g.setRenderTarget(lt,mt,Et),g.setClearColor(ht,at),yt!==void 0&&(B.viewport=yt),g.toneMapping=bt}function Bi(x,I,V){const B=I.isScene===!0?I.overrideMaterial:null;for(let N=0,rt=x.length;N<rt;N++){const ft=x[N],{object:lt,geometry:mt,group:Et}=ft;let bt=ft.material;bt.allowOverride===!0&&B!==null&&(bt=B),lt.layers.test(V.layers)&&Da(lt,I,V,mt,bt,Et)}}function Da(x,I,V,B,N,rt){x.onBeforeRender(g,I,V,B,N,rt),x.modelViewMatrix.multiplyMatrices(V.matrixWorldInverse,x.matrixWorld),x.normalMatrix.getNormalMatrix(x.modelViewMatrix),N.onBeforeRender(g,I,V,B,x,rt),N.transparent===!0&&N.side===$e&&N.forceSinglePass===!1?(N.side=ge,N.needsUpdate=!0,g.renderBufferDirect(V,I,B,N,x,rt),N.side=Pn,N.needsUpdate=!0,g.renderBufferDirect(V,I,B,N,x,rt),N.side=$e):g.renderBufferDirect(V,I,B,N,x,rt),x.onAfterRender(g,I,V,B,N,rt)}function zi(x,I,V){I.isScene!==!0&&(I=Jt);const B=m.get(x),N=T.state.lights,rt=T.state.shadowsArray,ft=N.state.version,lt=xt.getParameters(x,N.state,rt,I,V),mt=xt.getProgramCacheKey(lt);let Et=B.programs;B.environment=x.isMeshStandardMaterial?I.environment:null,B.fog=I.fog,B.envMap=(x.isMeshStandardMaterial?K:X).get(x.envMap||B.environment),B.envMapRotation=B.environment!==null&&x.envMap===null?I.environmentRotation:x.envMapRotation,Et===void 0&&(x.addEventListener("dispose",je),Et=new Map,B.programs=Et);let bt=Et.get(mt);if(bt!==void 0){if(B.currentProgram===bt&&B.lightsStateVersion===ft)return Ia(x,lt),bt}else lt.uniforms=xt.getUniforms(x),x.onBeforeCompile(lt,g),bt=xt.acquireProgram(lt,mt),Et.set(mt,bt),B.uniforms=lt.uniforms;const yt=B.uniforms;return(!x.isShaderMaterial&&!x.isRawShaderMaterial||x.clipping===!0)&&(yt.clippingPlanes=_t.uniform),Ia(x,lt),B.needsLights=wl(x),B.lightsStateVersion=ft,B.needsLights&&(yt.ambientLightColor.value=N.state.ambient,yt.lightProbe.value=N.state.probe,yt.directionalLights.value=N.state.directional,yt.directionalLightShadows.value=N.state.directionalShadow,yt.spotLights.value=N.state.spot,yt.spotLightShadows.value=N.state.spotShadow,yt.rectAreaLights.value=N.state.rectArea,yt.ltc_1.value=N.state.rectAreaLTC1,yt.ltc_2.value=N.state.rectAreaLTC2,yt.pointLights.value=N.state.point,yt.pointLightShadows.value=N.state.pointShadow,yt.hemisphereLights.value=N.state.hemi,yt.directionalShadowMap.value=N.state.directionalShadowMap,yt.directionalShadowMatrix.value=N.state.directionalShadowMatrix,yt.spotShadowMap.value=N.state.spotShadowMap,yt.spotLightMatrix.value=N.state.spotLightMatrix,yt.spotLightMap.value=N.state.spotLightMap,yt.pointShadowMap.value=N.state.pointShadowMap,yt.pointShadowMatrix.value=N.state.pointShadowMatrix),B.currentProgram=bt,B.uniformsList=null,bt}function La(x){if(x.uniformsList===null){const I=x.currentProgram.getUniforms();x.uniformsList=Ms.seqWithValue(I.seq,x.uniforms)}return x.uniformsList}function Ia(x,I){const V=m.get(x);V.outputColorSpace=I.outputColorSpace,V.batching=I.batching,V.batchingColor=I.batchingColor,V.instancing=I.instancing,V.instancingColor=I.instancingColor,V.instancingMorph=I.instancingMorph,V.skinning=I.skinning,V.morphTargets=I.morphTargets,V.morphNormals=I.morphNormals,V.morphColors=I.morphColors,V.morphTargetsCount=I.morphTargetsCount,V.numClippingPlanes=I.numClippingPlanes,V.numIntersection=I.numClipIntersection,V.vertexAlphas=I.vertexAlphas,V.vertexTangents=I.vertexTangents,V.toneMapping=I.toneMapping}function bl(x,I,V,B,N){I.isScene!==!0&&(I=Jt),L.resetTextureUnits();const rt=I.fog,ft=B.isMeshStandardMaterial?I.environment:null,lt=O===null?g.outputColorSpace:O.isXRRenderTarget===!0?O.texture.colorSpace:mi,mt=(B.isMeshStandardMaterial?K:X).get(B.envMap||ft),Et=B.vertexColors===!0&&!!V.attributes.color&&V.attributes.color.itemSize===4,bt=!!V.attributes.tangent&&(!!B.normalMap||B.anisotropy>0),yt=!!V.morphAttributes.position,Ot=!!V.morphAttributes.normal,Zt=!!V.morphAttributes.color;let ae=tn;B.toneMapped&&(O===null||O.isXRRenderTarget===!0)&&(ae=g.toneMapping);const oe=V.morphAttributes.position||V.morphAttributes.normal||V.morphAttributes.color,Qt=oe!==void 0?oe.length:0,Tt=m.get(B),jt=T.state.lights;if(gt===!0&&(kt===!0||x!==Y)){const Ae=x===Y&&B.id===H;_t.setState(B,x,Ae)}let Wt=!1;B.version===Tt.__version?(Tt.needsLights&&Tt.lightsStateVersion!==jt.state.version||Tt.outputColorSpace!==lt||N.isBatchedMesh&&Tt.batching===!1||!N.isBatchedMesh&&Tt.batching===!0||N.isBatchedMesh&&Tt.batchingColor===!0&&N.colorTexture===null||N.isBatchedMesh&&Tt.batchingColor===!1&&N.colorTexture!==null||N.isInstancedMesh&&Tt.instancing===!1||!N.isInstancedMesh&&Tt.instancing===!0||N.isSkinnedMesh&&Tt.skinning===!1||!N.isSkinnedMesh&&Tt.skinning===!0||N.isInstancedMesh&&Tt.instancingColor===!0&&N.instanceColor===null||N.isInstancedMesh&&Tt.instancingColor===!1&&N.instanceColor!==null||N.isInstancedMesh&&Tt.instancingMorph===!0&&N.morphTexture===null||N.isInstancedMesh&&Tt.instancingMorph===!1&&N.morphTexture!==null||Tt.envMap!==mt||B.fog===!0&&Tt.fog!==rt||Tt.numClippingPlanes!==void 0&&(Tt.numClippingPlanes!==_t.numPlanes||Tt.numIntersection!==_t.numIntersection)||Tt.vertexAlphas!==Et||Tt.vertexTangents!==bt||Tt.morphTargets!==yt||Tt.morphNormals!==Ot||Tt.morphColors!==Zt||Tt.toneMapping!==ae||Tt.morphTargetsCount!==Qt)&&(Wt=!0):(Wt=!0,Tt.__version=B.version);let Ue=Tt.currentProgram;Wt===!0&&(Ue=zi(B,I,N));let qn=!1,Ne=!1,xi=!1;const ne=Ue.getUniforms(),Ce=Tt.uniforms;if(vt.useProgram(Ue.program)&&(qn=!0,Ne=!0,xi=!0),B.id!==H&&(H=B.id,Ne=!0),qn||Y!==x){vt.buffers.depth.getReversed()&&x.reversedDepth!==!0&&(x._reversedDepth=!0,x.updateProjectionMatrix()),ne.setValue(R,"projectionMatrix",x.projectionMatrix),ne.setValue(R,"viewMatrix",x.matrixWorldInverse);const Pe=ne.map.cameraPosition;Pe!==void 0&&Pe.setValue(R,Vt.setFromMatrixPosition(x.matrixWorld)),te.logarithmicDepthBuffer&&ne.setValue(R,"logDepthBufFC",2/(Math.log(x.far+1)/Math.LN2)),(B.isMeshPhongMaterial||B.isMeshToonMaterial||B.isMeshLambertMaterial||B.isMeshBasicMaterial||B.isMeshStandardMaterial||B.isShaderMaterial)&&ne.setValue(R,"isOrthographic",x.isOrthographicCamera===!0),Y!==x&&(Y=x,Ne=!0,xi=!0)}if(Tt.needsLights&&(jt.state.directionalShadowMap.length>0&&ne.setValue(R,"directionalShadowMap",jt.state.directionalShadowMap,L),jt.state.spotShadowMap.length>0&&ne.setValue(R,"spotShadowMap",jt.state.spotShadowMap,L),jt.state.pointShadowMap.length>0&&ne.setValue(R,"pointShadowMap",jt.state.pointShadowMap,L)),N.isSkinnedMesh){ne.setOptional(R,N,"bindMatrix"),ne.setOptional(R,N,"bindMatrixInverse");const Ae=N.skeleton;Ae&&(Ae.boneTexture===null&&Ae.computeBoneTexture(),ne.setValue(R,"boneTexture",Ae.boneTexture,L))}N.isBatchedMesh&&(ne.setOptional(R,N,"batchingTexture"),ne.setValue(R,"batchingTexture",N._matricesTexture,L),ne.setOptional(R,N,"batchingIdTexture"),ne.setValue(R,"batchingIdTexture",N._indirectTexture,L),ne.setOptional(R,N,"batchingColorTexture"),N._colorsTexture!==null&&ne.setValue(R,"batchingColorTexture",N._colorsTexture,L));const Ve=V.morphAttributes;if((Ve.position!==void 0||Ve.normal!==void 0||Ve.color!==void 0)&&Nt.update(N,V,Ue),(Ne||Tt.receiveShadow!==N.receiveShadow)&&(Tt.receiveShadow=N.receiveShadow,ne.setValue(R,"receiveShadow",N.receiveShadow)),B.isMeshGouraudMaterial&&B.envMap!==null&&(Ce.envMap.value=mt,Ce.flipEnvMap.value=mt.isCubeTexture&&mt.isRenderTargetTexture===!1?-1:1),B.isMeshStandardMaterial&&B.envMap===null&&I.environment!==null&&(Ce.envMapIntensity.value=I.environmentIntensity),Ce.dfgLUT!==void 0&&(Ce.dfgLUT.value=sm()),Ne&&(ne.setValue(R,"toneMappingExposure",g.toneMappingExposure),Tt.needsLights&&Al(Ce,xi),rt&&B.fog===!0&&At.refreshFogUniforms(Ce,rt),At.refreshMaterialUniforms(Ce,B,It,Ft,T.state.transmissionRenderTarget[x.id]),Ms.upload(R,La(Tt),Ce,L)),B.isShaderMaterial&&B.uniformsNeedUpdate===!0&&(Ms.upload(R,La(Tt),Ce,L),B.uniformsNeedUpdate=!1),B.isSpriteMaterial&&ne.setValue(R,"center",N.center),ne.setValue(R,"modelViewMatrix",N.modelViewMatrix),ne.setValue(R,"normalMatrix",N.normalMatrix),ne.setValue(R,"modelMatrix",N.matrixWorld),B.isShaderMaterial||B.isRawShaderMaterial){const Ae=B.uniformsGroups;for(let Pe=0,Ls=Ae.length;Pe<Ls;Pe++){const Ln=Ae[Pe];J.update(Ln,Ue),J.bind(Ln,Ue)}}return Ue}function Al(x,I){x.ambientLightColor.needsUpdate=I,x.lightProbe.needsUpdate=I,x.directionalLights.needsUpdate=I,x.directionalLightShadows.needsUpdate=I,x.pointLights.needsUpdate=I,x.pointLightShadows.needsUpdate=I,x.spotLights.needsUpdate=I,x.spotLightShadows.needsUpdate=I,x.rectAreaLights.needsUpdate=I,x.hemisphereLights.needsUpdate=I}function wl(x){return x.isMeshLambertMaterial||x.isMeshToonMaterial||x.isMeshPhongMaterial||x.isMeshStandardMaterial||x.isShadowMaterial||x.isShaderMaterial&&x.lights===!0}this.getActiveCubeFace=function(){return D},this.getActiveMipmapLevel=function(){return z},this.getRenderTarget=function(){return O},this.setRenderTargetTextures=function(x,I,V){const B=m.get(x);B.__autoAllocateDepthBuffer=x.resolveDepthBuffer===!1,B.__autoAllocateDepthBuffer===!1&&(B.__useRenderToTexture=!1),m.get(x.texture).__webglTexture=I,m.get(x.depthTexture).__webglTexture=B.__autoAllocateDepthBuffer?void 0:V,B.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(x,I){const V=m.get(x);V.__webglFramebuffer=I,V.__useDefaultFramebuffer=I===void 0};const Rl=R.createFramebuffer();this.setRenderTarget=function(x,I=0,V=0){O=x,D=I,z=V;let B=null,N=!1,rt=!1;if(x){const lt=m.get(x);if(lt.__useDefaultFramebuffer!==void 0){vt.bindFramebuffer(R.FRAMEBUFFER,lt.__webglFramebuffer),G.copy(x.viewport),W.copy(x.scissor),Z=x.scissorTest,vt.viewport(G),vt.scissor(W),vt.setScissorTest(Z),H=-1;return}else if(lt.__webglFramebuffer===void 0)L.setupRenderTarget(x);else if(lt.__hasExternalTextures)L.rebindTextures(x,m.get(x.texture).__webglTexture,m.get(x.depthTexture).__webglTexture);else if(x.depthBuffer){const bt=x.depthTexture;if(lt.__boundDepthTexture!==bt){if(bt!==null&&m.has(bt)&&(x.width!==bt.image.width||x.height!==bt.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");L.setupDepthRenderbuffer(x)}}const mt=x.texture;(mt.isData3DTexture||mt.isDataArrayTexture||mt.isCompressedArrayTexture)&&(rt=!0);const Et=m.get(x).__webglFramebuffer;x.isWebGLCubeRenderTarget?(Array.isArray(Et[I])?B=Et[I][V]:B=Et[I],N=!0):x.samples>0&&L.useMultisampledRTT(x)===!1?B=m.get(x).__webglMultisampledFramebuffer:Array.isArray(Et)?B=Et[V]:B=Et,G.copy(x.viewport),W.copy(x.scissor),Z=x.scissorTest}else G.copy(q).multiplyScalar(It).floor(),W.copy($).multiplyScalar(It).floor(),Z=pt;if(V!==0&&(B=Rl),vt.bindFramebuffer(R.FRAMEBUFFER,B)&&vt.drawBuffers(x,B),vt.viewport(G),vt.scissor(W),vt.setScissorTest(Z),N){const lt=m.get(x.texture);R.framebufferTexture2D(R.FRAMEBUFFER,R.COLOR_ATTACHMENT0,R.TEXTURE_CUBE_MAP_POSITIVE_X+I,lt.__webglTexture,V)}else if(rt){const lt=I;for(let mt=0;mt<x.textures.length;mt++){const Et=m.get(x.textures[mt]);R.framebufferTextureLayer(R.FRAMEBUFFER,R.COLOR_ATTACHMENT0+mt,Et.__webglTexture,V,lt)}}else if(x!==null&&V!==0){const lt=m.get(x.texture);R.framebufferTexture2D(R.FRAMEBUFFER,R.COLOR_ATTACHMENT0,R.TEXTURE_2D,lt.__webglTexture,V)}H=-1},this.readRenderTargetPixels=function(x,I,V,B,N,rt,ft,lt=0){if(!(x&&x.isWebGLRenderTarget)){Gt("WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let mt=m.get(x).__webglFramebuffer;if(x.isWebGLCubeRenderTarget&&ft!==void 0&&(mt=mt[ft]),mt){vt.bindFramebuffer(R.FRAMEBUFFER,mt);try{const Et=x.textures[lt],bt=Et.format,yt=Et.type;if(!te.textureFormatReadable(bt)){Gt("WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!te.textureTypeReadable(yt)){Gt("WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}I>=0&&I<=x.width-B&&V>=0&&V<=x.height-N&&(x.textures.length>1&&R.readBuffer(R.COLOR_ATTACHMENT0+lt),R.readPixels(I,V,B,N,tt.convert(bt),tt.convert(yt),rt))}finally{const Et=O!==null?m.get(O).__webglFramebuffer:null;vt.bindFramebuffer(R.FRAMEBUFFER,Et)}}},this.readRenderTargetPixelsAsync=async function(x,I,V,B,N,rt,ft,lt=0){if(!(x&&x.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let mt=m.get(x).__webglFramebuffer;if(x.isWebGLCubeRenderTarget&&ft!==void 0&&(mt=mt[ft]),mt)if(I>=0&&I<=x.width-B&&V>=0&&V<=x.height-N){vt.bindFramebuffer(R.FRAMEBUFFER,mt);const Et=x.textures[lt],bt=Et.format,yt=Et.type;if(!te.textureFormatReadable(bt))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!te.textureTypeReadable(yt))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");const Ot=R.createBuffer();R.bindBuffer(R.PIXEL_PACK_BUFFER,Ot),R.bufferData(R.PIXEL_PACK_BUFFER,rt.byteLength,R.STREAM_READ),x.textures.length>1&&R.readBuffer(R.COLOR_ATTACHMENT0+lt),R.readPixels(I,V,B,N,tt.convert(bt),tt.convert(yt),0);const Zt=O!==null?m.get(O).__webglFramebuffer:null;vt.bindFramebuffer(R.FRAMEBUFFER,Zt);const ae=R.fenceSync(R.SYNC_GPU_COMMANDS_COMPLETE,0);return R.flush(),await _c(R,ae,4),R.bindBuffer(R.PIXEL_PACK_BUFFER,Ot),R.getBufferSubData(R.PIXEL_PACK_BUFFER,0,rt),R.deleteBuffer(Ot),R.deleteSync(ae),rt}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(x,I=null,V=0){const B=Math.pow(2,-V),N=Math.floor(x.image.width*B),rt=Math.floor(x.image.height*B),ft=I!==null?I.x:0,lt=I!==null?I.y:0;L.setTexture2D(x,0),R.copyTexSubImage2D(R.TEXTURE_2D,V,0,0,ft,lt,N,rt),vt.unbindTexture()};const Cl=R.createFramebuffer(),Pl=R.createFramebuffer();this.copyTextureToTexture=function(x,I,V=null,B=null,N=0,rt=null){rt===null&&(N!==0?(Di("WebGLRenderer: copyTextureToTexture function signature has changed to support src and dst mipmap levels."),rt=N,N=0):rt=0);let ft,lt,mt,Et,bt,yt,Ot,Zt,ae;const oe=x.isCompressedTexture?x.mipmaps[rt]:x.image;if(V!==null)ft=V.max.x-V.min.x,lt=V.max.y-V.min.y,mt=V.isBox3?V.max.z-V.min.z:1,Et=V.min.x,bt=V.min.y,yt=V.isBox3?V.min.z:0;else{const Ve=Math.pow(2,-N);ft=Math.floor(oe.width*Ve),lt=Math.floor(oe.height*Ve),x.isDataArrayTexture?mt=oe.depth:x.isData3DTexture?mt=Math.floor(oe.depth*Ve):mt=1,Et=0,bt=0,yt=0}B!==null?(Ot=B.x,Zt=B.y,ae=B.z):(Ot=0,Zt=0,ae=0);const Qt=tt.convert(I.format),Tt=tt.convert(I.type);let jt;I.isData3DTexture?(L.setTexture3D(I,0),jt=R.TEXTURE_3D):I.isDataArrayTexture||I.isCompressedArrayTexture?(L.setTexture2DArray(I,0),jt=R.TEXTURE_2D_ARRAY):(L.setTexture2D(I,0),jt=R.TEXTURE_2D),R.pixelStorei(R.UNPACK_FLIP_Y_WEBGL,I.flipY),R.pixelStorei(R.UNPACK_PREMULTIPLY_ALPHA_WEBGL,I.premultiplyAlpha),R.pixelStorei(R.UNPACK_ALIGNMENT,I.unpackAlignment);const Wt=R.getParameter(R.UNPACK_ROW_LENGTH),Ue=R.getParameter(R.UNPACK_IMAGE_HEIGHT),qn=R.getParameter(R.UNPACK_SKIP_PIXELS),Ne=R.getParameter(R.UNPACK_SKIP_ROWS),xi=R.getParameter(R.UNPACK_SKIP_IMAGES);R.pixelStorei(R.UNPACK_ROW_LENGTH,oe.width),R.pixelStorei(R.UNPACK_IMAGE_HEIGHT,oe.height),R.pixelStorei(R.UNPACK_SKIP_PIXELS,Et),R.pixelStorei(R.UNPACK_SKIP_ROWS,bt),R.pixelStorei(R.UNPACK_SKIP_IMAGES,yt);const ne=x.isDataArrayTexture||x.isData3DTexture,Ce=I.isDataArrayTexture||I.isData3DTexture;if(x.isDepthTexture){const Ve=m.get(x),Ae=m.get(I),Pe=m.get(Ve.__renderTarget),Ls=m.get(Ae.__renderTarget);vt.bindFramebuffer(R.READ_FRAMEBUFFER,Pe.__webglFramebuffer),vt.bindFramebuffer(R.DRAW_FRAMEBUFFER,Ls.__webglFramebuffer);for(let Ln=0;Ln<mt;Ln++)ne&&(R.framebufferTextureLayer(R.READ_FRAMEBUFFER,R.COLOR_ATTACHMENT0,m.get(x).__webglTexture,N,yt+Ln),R.framebufferTextureLayer(R.DRAW_FRAMEBUFFER,R.COLOR_ATTACHMENT0,m.get(I).__webglTexture,rt,ae+Ln)),R.blitFramebuffer(Et,bt,ft,lt,Ot,Zt,ft,lt,R.DEPTH_BUFFER_BIT,R.NEAREST);vt.bindFramebuffer(R.READ_FRAMEBUFFER,null),vt.bindFramebuffer(R.DRAW_FRAMEBUFFER,null)}else if(N!==0||x.isRenderTargetTexture||m.has(x)){const Ve=m.get(x),Ae=m.get(I);vt.bindFramebuffer(R.READ_FRAMEBUFFER,Cl),vt.bindFramebuffer(R.DRAW_FRAMEBUFFER,Pl);for(let Pe=0;Pe<mt;Pe++)ne?R.framebufferTextureLayer(R.READ_FRAMEBUFFER,R.COLOR_ATTACHMENT0,Ve.__webglTexture,N,yt+Pe):R.framebufferTexture2D(R.READ_FRAMEBUFFER,R.COLOR_ATTACHMENT0,R.TEXTURE_2D,Ve.__webglTexture,N),Ce?R.framebufferTextureLayer(R.DRAW_FRAMEBUFFER,R.COLOR_ATTACHMENT0,Ae.__webglTexture,rt,ae+Pe):R.framebufferTexture2D(R.DRAW_FRAMEBUFFER,R.COLOR_ATTACHMENT0,R.TEXTURE_2D,Ae.__webglTexture,rt),N!==0?R.blitFramebuffer(Et,bt,ft,lt,Ot,Zt,ft,lt,R.COLOR_BUFFER_BIT,R.NEAREST):Ce?R.copyTexSubImage3D(jt,rt,Ot,Zt,ae+Pe,Et,bt,ft,lt):R.copyTexSubImage2D(jt,rt,Ot,Zt,Et,bt,ft,lt);vt.bindFramebuffer(R.READ_FRAMEBUFFER,null),vt.bindFramebuffer(R.DRAW_FRAMEBUFFER,null)}else Ce?x.isDataTexture||x.isData3DTexture?R.texSubImage3D(jt,rt,Ot,Zt,ae,ft,lt,mt,Qt,Tt,oe.data):I.isCompressedArrayTexture?R.compressedTexSubImage3D(jt,rt,Ot,Zt,ae,ft,lt,mt,Qt,oe.data):R.texSubImage3D(jt,rt,Ot,Zt,ae,ft,lt,mt,Qt,Tt,oe):x.isDataTexture?R.texSubImage2D(R.TEXTURE_2D,rt,Ot,Zt,ft,lt,Qt,Tt,oe.data):x.isCompressedTexture?R.compressedTexSubImage2D(R.TEXTURE_2D,rt,Ot,Zt,oe.width,oe.height,Qt,oe.data):R.texSubImage2D(R.TEXTURE_2D,rt,Ot,Zt,ft,lt,Qt,Tt,oe);R.pixelStorei(R.UNPACK_ROW_LENGTH,Wt),R.pixelStorei(R.UNPACK_IMAGE_HEIGHT,Ue),R.pixelStorei(R.UNPACK_SKIP_PIXELS,qn),R.pixelStorei(R.UNPACK_SKIP_ROWS,Ne),R.pixelStorei(R.UNPACK_SKIP_IMAGES,xi),rt===0&&I.generateMipmaps&&R.generateMipmap(jt),vt.unbindTexture()},this.initRenderTarget=function(x){m.get(x).__webglFramebuffer===void 0&&L.setupRenderTarget(x)},this.initTexture=function(x){x.isCubeTexture?L.setTextureCube(x,0):x.isData3DTexture?L.setTexture3D(x,0):x.isDataArrayTexture||x.isCompressedArrayTexture?L.setTexture2DArray(x,0):L.setTexture2D(x,0),vt.unbindTexture()},this.resetState=function(){D=0,z=0,O=null,vt.reset(),dt.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return Qe}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(t){this._outputColorSpace=t;const e=this.getContext();e.drawingBufferColorSpace=Ht._getDrawingBufferColorSpace(t),e.unpackColorSpace=Ht._getUnpackColorSpace()}}const zo={type:"change"},ba={type:"start"},El={type:"end"},us=new Fi,Vo=new wn,am=Math.cos(70*xc.DEG2RAD),de=new U,Le=2*Math.PI,$t={NONE:-1,ROTATE:0,DOLLY:1,PAN:2,TOUCH_ROTATE:3,TOUCH_PAN:4,TOUCH_DOLLY_PAN:5,TOUCH_DOLLY_ROTATE:6},dr=1e-6;class om extends lh{constructor(t,e=null){super(t,e),this.state=$t.NONE,this.target=new U,this.cursor=new U,this.minDistance=0,this.maxDistance=1/0,this.minZoom=0,this.maxZoom=1/0,this.minTargetRadius=0,this.maxTargetRadius=1/0,this.minPolarAngle=0,this.maxPolarAngle=Math.PI,this.minAzimuthAngle=-1/0,this.maxAzimuthAngle=1/0,this.enableDamping=!1,this.dampingFactor=.05,this.enableZoom=!0,this.zoomSpeed=1,this.enableRotate=!0,this.rotateSpeed=1,this.keyRotateSpeed=1,this.enablePan=!0,this.panSpeed=1,this.screenSpacePanning=!0,this.keyPanSpeed=7,this.zoomToCursor=!1,this.autoRotate=!1,this.autoRotateSpeed=2,this.keys={LEFT:"ArrowLeft",UP:"ArrowUp",RIGHT:"ArrowRight",BOTTOM:"ArrowDown"},this.mouseButtons={LEFT:mn.ROTATE,MIDDLE:mn.DOLLY,RIGHT:mn.PAN},this.touches={ONE:li.ROTATE,TWO:li.DOLLY_PAN},this.target0=this.target.clone(),this.position0=this.object.position.clone(),this.zoom0=this.object.zoom,this._domElementKeyEvents=null,this._lastPosition=new U,this._lastQuaternion=new Wn,this._lastTargetPosition=new U,this._quat=new Wn().setFromUnitVectors(t.up,new U(0,1,0)),this._quatInverse=this._quat.clone().invert(),this._spherical=new po,this._sphericalDelta=new po,this._scale=1,this._panOffset=new U,this._rotateStart=new Ct,this._rotateEnd=new Ct,this._rotateDelta=new Ct,this._panStart=new Ct,this._panEnd=new Ct,this._panDelta=new Ct,this._dollyStart=new Ct,this._dollyEnd=new Ct,this._dollyDelta=new Ct,this._dollyDirection=new U,this._mouse=new Ct,this._performCursorZoom=!1,this._pointers=[],this._pointerPositions={},this._controlActive=!1,this._onPointerMove=cm.bind(this),this._onPointerDown=lm.bind(this),this._onPointerUp=hm.bind(this),this._onContextMenu=gm.bind(this),this._onMouseWheel=fm.bind(this),this._onKeyDown=pm.bind(this),this._onTouchStart=mm.bind(this),this._onTouchMove=_m.bind(this),this._onMouseDown=um.bind(this),this._onMouseMove=dm.bind(this),this._interceptControlDown=xm.bind(this),this._interceptControlUp=vm.bind(this),this.domElement!==null&&this.connect(this.domElement),this.update()}connect(t){super.connect(t),this.domElement.addEventListener("pointerdown",this._onPointerDown),this.domElement.addEventListener("pointercancel",this._onPointerUp),this.domElement.addEventListener("contextmenu",this._onContextMenu),this.domElement.addEventListener("wheel",this._onMouseWheel,{passive:!1}),this.domElement.getRootNode().addEventListener("keydown",this._interceptControlDown,{passive:!0,capture:!0}),this.domElement.style.touchAction="none"}disconnect(){this.domElement.removeEventListener("pointerdown",this._onPointerDown),this.domElement.ownerDocument.removeEventListener("pointermove",this._onPointerMove),this.domElement.ownerDocument.removeEventListener("pointerup",this._onPointerUp),this.domElement.removeEventListener("pointercancel",this._onPointerUp),this.domElement.removeEventListener("wheel",this._onMouseWheel),this.domElement.removeEventListener("contextmenu",this._onContextMenu),this.stopListenToKeyEvents(),this.domElement.getRootNode().removeEventListener("keydown",this._interceptControlDown,{capture:!0}),this.domElement.style.touchAction="auto"}dispose(){this.disconnect()}getPolarAngle(){return this._spherical.phi}getAzimuthalAngle(){return this._spherical.theta}getDistance(){return this.object.position.distanceTo(this.target)}listenToKeyEvents(t){t.addEventListener("keydown",this._onKeyDown),this._domElementKeyEvents=t}stopListenToKeyEvents(){this._domElementKeyEvents!==null&&(this._domElementKeyEvents.removeEventListener("keydown",this._onKeyDown),this._domElementKeyEvents=null)}saveState(){this.target0.copy(this.target),this.position0.copy(this.object.position),this.zoom0=this.object.zoom}reset(){this.target.copy(this.target0),this.object.position.copy(this.position0),this.object.zoom=this.zoom0,this.object.updateProjectionMatrix(),this.dispatchEvent(zo),this.update(),this.state=$t.NONE}update(t=null){const e=this.object.position;de.copy(e).sub(this.target),de.applyQuaternion(this._quat),this._spherical.setFromVector3(de),this.autoRotate&&this.state===$t.NONE&&this._rotateLeft(this._getAutoRotationAngle(t)),this.enableDamping?(this._spherical.theta+=this._sphericalDelta.theta*this.dampingFactor,this._spherical.phi+=this._sphericalDelta.phi*this.dampingFactor):(this._spherical.theta+=this._sphericalDelta.theta,this._spherical.phi+=this._sphericalDelta.phi);let n=this.minAzimuthAngle,s=this.maxAzimuthAngle;isFinite(n)&&isFinite(s)&&(n<-Math.PI?n+=Le:n>Math.PI&&(n-=Le),s<-Math.PI?s+=Le:s>Math.PI&&(s-=Le),n<=s?this._spherical.theta=Math.max(n,Math.min(s,this._spherical.theta)):this._spherical.theta=this._spherical.theta>(n+s)/2?Math.max(n,this._spherical.theta):Math.min(s,this._spherical.theta)),this._spherical.phi=Math.max(this.minPolarAngle,Math.min(this.maxPolarAngle,this._spherical.phi)),this._spherical.makeSafe(),this.enableDamping===!0?this.target.addScaledVector(this._panOffset,this.dampingFactor):this.target.add(this._panOffset),this.target.sub(this.cursor),this.target.clampLength(this.minTargetRadius,this.maxTargetRadius),this.target.add(this.cursor);let r=!1;if(this.zoomToCursor&&this._performCursorZoom||this.object.isOrthographicCamera)this._spherical.radius=this._clampDistance(this._spherical.radius);else{const a=this._spherical.radius;this._spherical.radius=this._clampDistance(this._spherical.radius*this._scale),r=a!=this._spherical.radius}if(de.setFromSpherical(this._spherical),de.applyQuaternion(this._quatInverse),e.copy(this.target).add(de),this.object.lookAt(this.target),this.enableDamping===!0?(this._sphericalDelta.theta*=1-this.dampingFactor,this._sphericalDelta.phi*=1-this.dampingFactor,this._panOffset.multiplyScalar(1-this.dampingFactor)):(this._sphericalDelta.set(0,0,0),this._panOffset.set(0,0,0)),this.zoomToCursor&&this._performCursorZoom){let a=null;if(this.object.isPerspectiveCamera){const o=de.length();a=this._clampDistance(o*this._scale);const c=o-a;this.object.position.addScaledVector(this._dollyDirection,c),this.object.updateMatrixWorld(),r=!!c}else if(this.object.isOrthographicCamera){const o=new U(this._mouse.x,this._mouse.y,0);o.unproject(this.object);const c=this.object.zoom;this.object.zoom=Math.max(this.minZoom,Math.min(this.maxZoom,this.object.zoom/this._scale)),this.object.updateProjectionMatrix(),r=c!==this.object.zoom;const l=new U(this._mouse.x,this._mouse.y,0);l.unproject(this.object),this.object.position.sub(l).add(o),this.object.updateMatrixWorld(),a=de.length()}else console.warn("WARNING: OrbitControls.js encountered an unknown camera type - zoom to cursor disabled."),this.zoomToCursor=!1;a!==null&&(this.screenSpacePanning?this.target.set(0,0,-1).transformDirection(this.object.matrix).multiplyScalar(a).add(this.object.position):(us.origin.copy(this.object.position),us.direction.set(0,0,-1).transformDirection(this.object.matrix),Math.abs(this.object.up.dot(us.direction))<am?this.object.lookAt(this.target):(Vo.setFromNormalAndCoplanarPoint(this.object.up,this.target),us.intersectPlane(Vo,this.target))))}else if(this.object.isOrthographicCamera){const a=this.object.zoom;this.object.zoom=Math.max(this.minZoom,Math.min(this.maxZoom,this.object.zoom/this._scale)),a!==this.object.zoom&&(this.object.updateProjectionMatrix(),r=!0)}return this._scale=1,this._performCursorZoom=!1,r||this._lastPosition.distanceToSquared(this.object.position)>dr||8*(1-this._lastQuaternion.dot(this.object.quaternion))>dr||this._lastTargetPosition.distanceToSquared(this.target)>dr?(this.dispatchEvent(zo),this._lastPosition.copy(this.object.position),this._lastQuaternion.copy(this.object.quaternion),this._lastTargetPosition.copy(this.target),!0):!1}_getAutoRotationAngle(t){return t!==null?Le/60*this.autoRotateSpeed*t:Le/60/60*this.autoRotateSpeed}_getZoomScale(t){const e=Math.abs(t*.01);return Math.pow(.95,this.zoomSpeed*e)}_rotateLeft(t){this._sphericalDelta.theta-=t}_rotateUp(t){this._sphericalDelta.phi-=t}_panLeft(t,e){de.setFromMatrixColumn(e,0),de.multiplyScalar(-t),this._panOffset.add(de)}_panUp(t,e){this.screenSpacePanning===!0?de.setFromMatrixColumn(e,1):(de.setFromMatrixColumn(e,0),de.crossVectors(this.object.up,de)),de.multiplyScalar(t),this._panOffset.add(de)}_pan(t,e){const n=this.domElement;if(this.object.isPerspectiveCamera){const s=this.object.position;de.copy(s).sub(this.target);let r=de.length();r*=Math.tan(this.object.fov/2*Math.PI/180),this._panLeft(2*t*r/n.clientHeight,this.object.matrix),this._panUp(2*e*r/n.clientHeight,this.object.matrix)}else this.object.isOrthographicCamera?(this._panLeft(t*(this.object.right-this.object.left)/this.object.zoom/n.clientWidth,this.object.matrix),this._panUp(e*(this.object.top-this.object.bottom)/this.object.zoom/n.clientHeight,this.object.matrix)):(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - pan disabled."),this.enablePan=!1)}_dollyOut(t){this.object.isPerspectiveCamera||this.object.isOrthographicCamera?this._scale/=t:(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled."),this.enableZoom=!1)}_dollyIn(t){this.object.isPerspectiveCamera||this.object.isOrthographicCamera?this._scale*=t:(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled."),this.enableZoom=!1)}_updateZoomParameters(t,e){if(!this.zoomToCursor)return;this._performCursorZoom=!0;const n=this.domElement.getBoundingClientRect(),s=t-n.left,r=e-n.top,a=n.width,o=n.height;this._mouse.x=s/a*2-1,this._mouse.y=-(r/o)*2+1,this._dollyDirection.set(this._mouse.x,this._mouse.y,1).unproject(this.object).sub(this.object.position).normalize()}_clampDistance(t){return Math.max(this.minDistance,Math.min(this.maxDistance,t))}_handleMouseDownRotate(t){this._rotateStart.set(t.clientX,t.clientY)}_handleMouseDownDolly(t){this._updateZoomParameters(t.clientX,t.clientX),this._dollyStart.set(t.clientX,t.clientY)}_handleMouseDownPan(t){this._panStart.set(t.clientX,t.clientY)}_handleMouseMoveRotate(t){this._rotateEnd.set(t.clientX,t.clientY),this._rotateDelta.subVectors(this._rotateEnd,this._rotateStart).multiplyScalar(this.rotateSpeed);const e=this.domElement;this._rotateLeft(Le*this._rotateDelta.x/e.clientHeight),this._rotateUp(Le*this._rotateDelta.y/e.clientHeight),this._rotateStart.copy(this._rotateEnd),this.update()}_handleMouseMoveDolly(t){this._dollyEnd.set(t.clientX,t.clientY),this._dollyDelta.subVectors(this._dollyEnd,this._dollyStart),this._dollyDelta.y>0?this._dollyOut(this._getZoomScale(this._dollyDelta.y)):this._dollyDelta.y<0&&this._dollyIn(this._getZoomScale(this._dollyDelta.y)),this._dollyStart.copy(this._dollyEnd),this.update()}_handleMouseMovePan(t){this._panEnd.set(t.clientX,t.clientY),this._panDelta.subVectors(this._panEnd,this._panStart).multiplyScalar(this.panSpeed),this._pan(this._panDelta.x,this._panDelta.y),this._panStart.copy(this._panEnd),this.update()}_handleMouseWheel(t){this._updateZoomParameters(t.clientX,t.clientY),t.deltaY<0?this._dollyIn(this._getZoomScale(t.deltaY)):t.deltaY>0&&this._dollyOut(this._getZoomScale(t.deltaY)),this.update()}_handleKeyDown(t){let e=!1;switch(t.code){case this.keys.UP:t.ctrlKey||t.metaKey||t.shiftKey?this.enableRotate&&this._rotateUp(Le*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(0,this.keyPanSpeed),e=!0;break;case this.keys.BOTTOM:t.ctrlKey||t.metaKey||t.shiftKey?this.enableRotate&&this._rotateUp(-Le*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(0,-this.keyPanSpeed),e=!0;break;case this.keys.LEFT:t.ctrlKey||t.metaKey||t.shiftKey?this.enableRotate&&this._rotateLeft(Le*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(this.keyPanSpeed,0),e=!0;break;case this.keys.RIGHT:t.ctrlKey||t.metaKey||t.shiftKey?this.enableRotate&&this._rotateLeft(-Le*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(-this.keyPanSpeed,0),e=!0;break}e&&(t.preventDefault(),this.update())}_handleTouchStartRotate(t){if(this._pointers.length===1)this._rotateStart.set(t.pageX,t.pageY);else{const e=this._getSecondPointerPosition(t),n=.5*(t.pageX+e.x),s=.5*(t.pageY+e.y);this._rotateStart.set(n,s)}}_handleTouchStartPan(t){if(this._pointers.length===1)this._panStart.set(t.pageX,t.pageY);else{const e=this._getSecondPointerPosition(t),n=.5*(t.pageX+e.x),s=.5*(t.pageY+e.y);this._panStart.set(n,s)}}_handleTouchStartDolly(t){const e=this._getSecondPointerPosition(t),n=t.pageX-e.x,s=t.pageY-e.y,r=Math.sqrt(n*n+s*s);this._dollyStart.set(0,r)}_handleTouchStartDollyPan(t){this.enableZoom&&this._handleTouchStartDolly(t),this.enablePan&&this._handleTouchStartPan(t)}_handleTouchStartDollyRotate(t){this.enableZoom&&this._handleTouchStartDolly(t),this.enableRotate&&this._handleTouchStartRotate(t)}_handleTouchMoveRotate(t){if(this._pointers.length==1)this._rotateEnd.set(t.pageX,t.pageY);else{const n=this._getSecondPointerPosition(t),s=.5*(t.pageX+n.x),r=.5*(t.pageY+n.y);this._rotateEnd.set(s,r)}this._rotateDelta.subVectors(this._rotateEnd,this._rotateStart).multiplyScalar(this.rotateSpeed);const e=this.domElement;this._rotateLeft(Le*this._rotateDelta.x/e.clientHeight),this._rotateUp(Le*this._rotateDelta.y/e.clientHeight),this._rotateStart.copy(this._rotateEnd)}_handleTouchMovePan(t){if(this._pointers.length===1)this._panEnd.set(t.pageX,t.pageY);else{const e=this._getSecondPointerPosition(t),n=.5*(t.pageX+e.x),s=.5*(t.pageY+e.y);this._panEnd.set(n,s)}this._panDelta.subVectors(this._panEnd,this._panStart).multiplyScalar(this.panSpeed),this._pan(this._panDelta.x,this._panDelta.y),this._panStart.copy(this._panEnd)}_handleTouchMoveDolly(t){const e=this._getSecondPointerPosition(t),n=t.pageX-e.x,s=t.pageY-e.y,r=Math.sqrt(n*n+s*s);this._dollyEnd.set(0,r),this._dollyDelta.set(0,Math.pow(this._dollyEnd.y/this._dollyStart.y,this.zoomSpeed)),this._dollyOut(this._dollyDelta.y),this._dollyStart.copy(this._dollyEnd);const a=(t.pageX+e.x)*.5,o=(t.pageY+e.y)*.5;this._updateZoomParameters(a,o)}_handleTouchMoveDollyPan(t){this.enableZoom&&this._handleTouchMoveDolly(t),this.enablePan&&this._handleTouchMovePan(t)}_handleTouchMoveDollyRotate(t){this.enableZoom&&this._handleTouchMoveDolly(t),this.enableRotate&&this._handleTouchMoveRotate(t)}_addPointer(t){this._pointers.push(t.pointerId)}_removePointer(t){delete this._pointerPositions[t.pointerId];for(let e=0;e<this._pointers.length;e++)if(this._pointers[e]==t.pointerId){this._pointers.splice(e,1);return}}_isTrackingPointer(t){for(let e=0;e<this._pointers.length;e++)if(this._pointers[e]==t.pointerId)return!0;return!1}_trackPointer(t){let e=this._pointerPositions[t.pointerId];e===void 0&&(e=new Ct,this._pointerPositions[t.pointerId]=e),e.set(t.pageX,t.pageY)}_getSecondPointerPosition(t){const e=t.pointerId===this._pointers[0]?this._pointers[1]:this._pointers[0];return this._pointerPositions[e]}_customWheelEvent(t){const e=t.deltaMode,n={clientX:t.clientX,clientY:t.clientY,deltaY:t.deltaY};switch(e){case 1:n.deltaY*=16;break;case 2:n.deltaY*=100;break}return t.ctrlKey&&!this._controlActive&&(n.deltaY*=10),n}}function lm(i){this.enabled!==!1&&(this._pointers.length===0&&(this.domElement.setPointerCapture(i.pointerId),this.domElement.ownerDocument.addEventListener("pointermove",this._onPointerMove),this.domElement.ownerDocument.addEventListener("pointerup",this._onPointerUp)),!this._isTrackingPointer(i)&&(this._addPointer(i),i.pointerType==="touch"?this._onTouchStart(i):this._onMouseDown(i)))}function cm(i){this.enabled!==!1&&(i.pointerType==="touch"?this._onTouchMove(i):this._onMouseMove(i))}function hm(i){switch(this._removePointer(i),this._pointers.length){case 0:this.domElement.releasePointerCapture(i.pointerId),this.domElement.ownerDocument.removeEventListener("pointermove",this._onPointerMove),this.domElement.ownerDocument.removeEventListener("pointerup",this._onPointerUp),this.dispatchEvent(El),this.state=$t.NONE;break;case 1:const t=this._pointers[0],e=this._pointerPositions[t];this._onTouchStart({pointerId:t,pageX:e.x,pageY:e.y});break}}function um(i){let t;switch(i.button){case 0:t=this.mouseButtons.LEFT;break;case 1:t=this.mouseButtons.MIDDLE;break;case 2:t=this.mouseButtons.RIGHT;break;default:t=-1}switch(t){case mn.DOLLY:if(this.enableZoom===!1)return;this._handleMouseDownDolly(i),this.state=$t.DOLLY;break;case mn.ROTATE:if(i.ctrlKey||i.metaKey||i.shiftKey){if(this.enablePan===!1)return;this._handleMouseDownPan(i),this.state=$t.PAN}else{if(this.enableRotate===!1)return;this._handleMouseDownRotate(i),this.state=$t.ROTATE}break;case mn.PAN:if(i.ctrlKey||i.metaKey||i.shiftKey){if(this.enableRotate===!1)return;this._handleMouseDownRotate(i),this.state=$t.ROTATE}else{if(this.enablePan===!1)return;this._handleMouseDownPan(i),this.state=$t.PAN}break;default:this.state=$t.NONE}this.state!==$t.NONE&&this.dispatchEvent(ba)}function dm(i){switch(this.state){case $t.ROTATE:if(this.enableRotate===!1)return;this._handleMouseMoveRotate(i);break;case $t.DOLLY:if(this.enableZoom===!1)return;this._handleMouseMoveDolly(i);break;case $t.PAN:if(this.enablePan===!1)return;this._handleMouseMovePan(i);break}}function fm(i){this.enabled===!1||this.enableZoom===!1||this.state!==$t.NONE||(i.preventDefault(),this.dispatchEvent(ba),this._handleMouseWheel(this._customWheelEvent(i)),this.dispatchEvent(El))}function pm(i){this.enabled!==!1&&this._handleKeyDown(i)}function mm(i){switch(this._trackPointer(i),this._pointers.length){case 1:switch(this.touches.ONE){case li.ROTATE:if(this.enableRotate===!1)return;this._handleTouchStartRotate(i),this.state=$t.TOUCH_ROTATE;break;case li.PAN:if(this.enablePan===!1)return;this._handleTouchStartPan(i),this.state=$t.TOUCH_PAN;break;default:this.state=$t.NONE}break;case 2:switch(this.touches.TWO){case li.DOLLY_PAN:if(this.enableZoom===!1&&this.enablePan===!1)return;this._handleTouchStartDollyPan(i),this.state=$t.TOUCH_DOLLY_PAN;break;case li.DOLLY_ROTATE:if(this.enableZoom===!1&&this.enableRotate===!1)return;this._handleTouchStartDollyRotate(i),this.state=$t.TOUCH_DOLLY_ROTATE;break;default:this.state=$t.NONE}break;default:this.state=$t.NONE}this.state!==$t.NONE&&this.dispatchEvent(ba)}function _m(i){switch(this._trackPointer(i),this.state){case $t.TOUCH_ROTATE:if(this.enableRotate===!1)return;this._handleTouchMoveRotate(i),this.update();break;case $t.TOUCH_PAN:if(this.enablePan===!1)return;this._handleTouchMovePan(i),this.update();break;case $t.TOUCH_DOLLY_PAN:if(this.enableZoom===!1&&this.enablePan===!1)return;this._handleTouchMoveDollyPan(i),this.update();break;case $t.TOUCH_DOLLY_ROTATE:if(this.enableZoom===!1&&this.enableRotate===!1)return;this._handleTouchMoveDollyRotate(i),this.update();break;default:this.state=$t.NONE}}function gm(i){this.enabled!==!1&&i.preventDefault()}function xm(i){i.key==="Control"&&(this._controlActive=!0,this.domElement.getRootNode().addEventListener("keyup",this._interceptControlUp,{passive:!0,capture:!0}))}function vm(i){i.key==="Control"&&(this._controlActive=!1,this.domElement.getRootNode().removeEventListener("keyup",this._interceptControlUp,{passive:!0,capture:!0}))}const Mm={class:"fixed inset-0 w-full h-full overflow-hidden bg-[#030308]"},Sm={key:0,class:"absolute inset-0 flex items-center justify-center z-50 bg-[#030308]"},Em={key:0,class:"absolute bottom-24 left-1/2 -translate-x-1/2 z-20 w-[90%] max-w-md"},ym={class:"backdrop-blur-xl bg-black/60 rounded-2xl border border-amber-500/30 p-5 shadow-2xl shadow-amber-500/10"},Tm={class:"flex items-start gap-4"},bm={class:"flex-1"},Am={class:"text-lg font-semibold text-amber-100"},wm={class:"text-xs text-amber-300/60 mb-2"},Rm={class:"text-sm text-gray-300/80 leading-relaxed"},Cm={__name:"SolarSystem",setup(i){const t=Vi(null);Vi(null);const e=Vi(null),n=Vi(!0);let s,r,a,o,c=null,l=[];const u=[{name:"沙漏孪星",nameEn:"Hourglass Twins",color:16041876,emissive:13935988,size:.8,orbitRadius:12,orbitSpeed:.008,rotationSpeed:.02,description:"两颗被引力锁定的行星，沙子在它们之间永恒流动"},{name:"脆壳星",nameEn:"Brittle Hollow",color:8035274,emissive:5929898,size:1.2,orbitRadius:20,orbitSpeed:.005,rotationSpeed:.015,description:"一颗正在被黑洞吞噬的行星，地壳不断崩塌"},{name:"巨人深处",nameEn:"Giant's Deep",color:5085818,emissive:4033130,size:2,orbitRadius:32,orbitSpeed:.003,rotationSpeed:.01,description:"被飓风笼罩的气态行星，隐藏着惊人的秘密"},{name:"黑棘星",nameEn:"Dark Bramble",color:4880986,emissive:3828298,size:1.5,orbitRadius:45,orbitSpeed:.002,rotationSpeed:.005,description:"一个充满迷雾与危险的神秘空间，内部比外部更大"},{name:"木炉星",nameEn:"Timber Hearth",color:8043130,emissive:5937754,size:1,orbitRadius:58,orbitSpeed:.0015,rotationSpeed:.012,description:"你的家园，一切冒险的起点"},{name:"量子卫星",nameEn:"Quantum Moon",color:12237546,emissive:10132170,size:.5,orbitRadius:70,orbitSpeed:.001,rotationSpeed:.025,description:"一颗神秘的卫星，在不被观测时会瞬移到不同行星"}],d=()=>{const E=document.createElement("canvas");E.width=64,E.height=64;const T=E.getContext("2d"),b=T.createRadialGradient(32,32,0,32,32,32);return b.addColorStop(0,"rgba(255, 255, 255, 1)"),b.addColorStop(.15,"rgba(255, 255, 255, 1)"),b.addColorStop(.3,"rgba(255, 255, 255, 0.8)"),b.addColorStop(.5,"rgba(255, 255, 255, 0.4)"),b.addColorStop(1,"rgba(255, 255, 255, 0)"),T.fillStyle=b,T.fillRect(0,0,64,64),new Kc(E)},f=()=>{const E=new Ie,T=[],b=[];for(let g=0;g<12e3;g++){const S=300+Math.random()*1700,D=Math.random()*Math.PI*2,z=Math.acos(2*Math.random()-1),O=S*Math.sin(z)*Math.cos(D),H=S*Math.sin(z)*Math.sin(D),Y=S*Math.cos(z);T.push(O,H,Y);const G=Math.random();G<.1?b.push(1,.9,.7):G<.2?b.push(.85,.95,1):b.push(1,1,1)}E.setAttribute("position",new be(T,3)),E.setAttribute("color",new be(b,3));const C=d(),F=new pl({size:3,map:C,vertexColors:!0,transparent:!0,opacity:1,sizeAttenuation:!0,depthWrite:!1,blending:pr});return new jc(E,F)},_=()=>{const E=new ci,T=new fn(4,64,64),b=new An({color:16755251}),C=new Ee(T,b);E.add(C);const F=new fn(4.5,32,32),g=new An({color:16737792,transparent:!0,opacity:.3,side:ge}),S=new Ee(F,g);E.add(S);const D=new fn(6,32,32),z=new An({color:16729088,transparent:!0,opacity:.15,side:ge}),O=new Ee(D,z);E.add(O);const H=new sh(16768392,3,800);H.position.set(0,0,0),E.add(H);const Y=new rh(5596808,.8);s.add(Y);const G=new eh(16777198,2241348,.6);return s.add(G),E},v=E=>{const b=new Ie,C=[];for(let g=0;g<=128;g++){const S=g/128*Math.PI*2;C.push(Math.cos(S)*E,0,Math.sin(S)*E)}b.setAttribute("position",new be(C,3));const F=new fl({color:3359829,transparent:!0,opacity:.4});return new qc(b,F)},M=E=>{const T=new ci,b=new fn(E.size,32,32),C=new Jc({color:E.color,emissive:E.emissive,emissiveIntensity:.6,roughness:.5,metalness:.2}),F=new Ee(b,C);T.add(F);const g=new fn(E.size*1.15,32,32),S=new An({color:E.color,transparent:!0,opacity:.2,side:ge}),D=new Ee(g,S);if(T.add(D),E.name==="巨人深处"){const z=new fn(E.size*1.1,32,32),O=new An({color:8960938,transparent:!0,opacity:.3,side:$e}),H=new Ee(z,O);T.add(H)}if(E.name==="量子卫星"){const z=new fn(E.size*1.3,16,16),O=new An({color:11184895,transparent:!0,opacity:.15,side:ge}),H=new Ee(z,O);T.add(H)}return T.userData={...E,angle:Math.random()*Math.PI*2,mesh:F},T},p=()=>{s=new Hc,r=new Be(60,t.value.clientWidth/t.value.clientHeight,.1,3e3),r.position.set(50,40,80),a=new rm({antialias:!0,alpha:!0}),a.setSize(t.value.clientWidth,t.value.clientHeight),a.setPixelRatio(Math.min(window.devicePixelRatio,2)),a.toneMapping=da,a.toneMappingExposure=1.2,t.value.appendChild(a.domElement),o=new om(r,a.domElement),o.enableDamping=!0,o.dampingFactor=.05,o.minDistance=10,o.maxDistance=300,o.enablePan=!0,o.panSpeed=1,o.rotateSpeed=.5,o.zoomSpeed=1.2,o.screenSpacePanning=!0,o.mouseButtons={LEFT:mn.ROTATE,MIDDLE:mn.PAN,RIGHT:mn.PAN},s.add(f()),s.add(_()),u.forEach(E=>{const T=v(E.orbitRadius);s.add(T);const b=M(E);s.add(b),l.push(b)}),n.value=!1},h=()=>{c=requestAnimationFrame(h),l.forEach(E=>{const T=E.userData;T.angle+=T.orbitSpeed,E.position.x=Math.cos(T.angle)*T.orbitRadius,E.position.z=Math.sin(T.angle)*T.orbitRadius,T.mesh&&(T.mesh.rotation.y+=T.rotationSpeed)}),o.update(),a.render(s,r)},A=()=>{t.value&&(r.aspect=t.value.clientWidth/t.value.clientHeight,r.updateProjectionMatrix(),a.setSize(t.value.clientWidth,t.value.clientHeight))},w=E=>{const T=t.value.getBoundingClientRect(),b=new Ct((E.clientX-T.left)/T.width*2-1,-((E.clientY-T.top)/T.height)*2+1),C=new oh;C.setFromCamera(b,r);const F=l.map(S=>S.userData.mesh).filter(Boolean),g=C.intersectObjects(F);if(g.length>0){const S=g[0].object,D=l.find(z=>z.userData.mesh===S);D&&(e.value=D.userData)}else e.value=null};return Ll(()=>{typeof window<"u"&&t.value&&(p(),h(),window.addEventListener("resize",A),t.value.addEventListener("click",w))}),Il(()=>{c&&cancelAnimationFrame(c),window.removeEventListener("resize",A),t.value&&t.value.removeEventListener("click",w),a&&a.dispose()}),(E,T)=>(fs(),ds("div",Mm,[n.value?(fs(),ds("div",Sm,[...T[1]||(T[1]=[we("div",{class:"text-center"},[we("div",{class:"w-16 h-16 border-4 border-amber-500/30 border-t-amber-500 rounded-full animate-spin mx-auto mb-4"}),we("div",{class:"text-amber-200/80 text-lg tracking-widest font-light"},"探索宇宙中...")],-1)])])):Ua("",!0),we("div",{ref_key:"containerRef",ref:t,class:"w-full h-full"},null,512),T[2]||(T[2]=we("div",{class:"absolute top-4 left-4 md:top-6 md:left-6 z-10 pointer-events-none"},[we("div",{class:"text-2xl md:text-3xl font-bold text-amber-100/90 tracking-wider drop-shadow-[0_0_20px_rgba(255,170,50,0.3)]"}," 星际拓荒 "),we("div",{class:"text-xs md:text-sm text-amber-200/50 mt-1 tracking-wide"}," OUTER WILDS SOLAR SYSTEM ")],-1)),fr(Nl,{"enter-active-class":"transition-all duration-300 ease-out","leave-active-class":"transition-all duration-200 ease-in","enter-from-class":"opacity-0 translate-y-4","leave-to-class":"opacity-0 translate-y-4"},{default:Go(()=>[e.value?(fs(),ds("div",Em,[we("div",ym,[we("div",Tm,[we("div",{class:"w-12 h-12 rounded-full shrink-0 shadow-lg",style:Ul({backgroundColor:"#"+e.value.color.toString(16).padStart(6,"0"),boxShadow:"0 0 20px #"+e.value.color.toString(16).padStart(6,"0")+"60"})},null,4),we("div",bm,[we("div",Am,Is(e.value.name),1),we("div",wm,Is(e.value.nameEn),1),we("div",Rm,Is(e.value.description),1)])]),we("button",{onClick:T[0]||(T[0]=b=>e.value=null),class:"absolute top-3 right-3 w-6 h-6 flex items-center justify-center text-gray-400 hover:text-white transition-colors"}," ✕ ")])])):Ua("",!0)]),_:1})]))}},Pm=Dl(Cm,[["__scopeId","data-v-9a500582"]]),Im=JSON.parse('{"title":"星际拓荒太阳系","description":"","frontmatter":{"layout":"page","navbar":false,"title":"星际拓荒太阳系","music":"https://raw.githubusercontent.com/v-laughing/assets/master/music/Outer-Wilds.mp3"},"headers":[],"relativePath":"workshop/solar-system.md","filePath":"workshop/solar-system.md"}'),Dm={name:"workshop/solar-system.md"},Um=Object.assign(Dm,{setup(i){return(t,e)=>{const n=Fl("ClientOnly");return fs(),ds("div",null,[fr(n,null,{default:Go(()=>[fr(Pm)]),_:1})])}}});export{Im as __pageData,Um as default};
